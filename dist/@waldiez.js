...
class WaldiezAgentData {
  ...
  constructor(props = {
    ...
    __publicField(this, "humanInputMode");
    __publicField(this, "codeExecutionConfig");
    __publicField(this, "agentDefaultAutoReply");
    __publicField(this, "maxConsecutiveAutoReply");
    __publicField(this, "termination");
    __publicField(this, "modelIds");
    __publicField(this, "tools");
    __publicField(this, "parentId");
    __publicField(this, "nestedChats");
    __publicField(this, "contextVariables");
    __publicField(this, "updateAgentStateBeforeReply");
    __publicField(this, "afterWork");
...
class MessageValidator {
  ...
  static isValidTextMessage(data) {
    return data && typeof data === "object" && (data.type === "text" || data.type === "tool_call") && data.content && typeof data.content === "object" && data.content.content !== void 0 && typeof data.content.sender === "string" && typeof data.content.recipient === "string";
  }
  /**
  ...
  static isValidTerminationMessage(data) {
    return data && typeof data === "object" && data.type === "termination" && data.content && typeof data.content === "object" && typeof data.content.termination_reason === "string";
  }
  /**
...
class MessageUtils {
  ...
  static generateTimestamp(data) {
    return data.timestamp || (/* @__PURE__ */ new Date()).toISOString();
  }
  static replaceImageUrls(content, imageUrl) {
    var _a;
    ...
    if (Array.isArray(content)) {
      return content.map((item) => {
        var _a2;
        if (item.type === "image_url" && ((_a2 = item.image_url) == null ? void 0 : _a2.url)) {
    ...
    if (typeof content === "object" && content !== null && "type" in content) {
      if (content.type === "image_url" && "image_url" in content && content.image_url && typeof content.image_url === "object" && "url" in content.image_url && ((_a = content.image_url) == null ? void 0 : _a.url)) {
        return updateImageUrl(content);
      }
  ...
  static normalizeContent(content, imageUrl) {
    if (typeof content === "string") {
      if (imageUrl) {
        const imgRegex = /<img\s+(?!.*src=)([^"'>\s]+)\s*\/?>/g;
  ...
  static generateSpeakerSelectionMarkdown(agents) {
  ...
  extractParticipants(dataContent) {
    try {
      ...
      if (MessageValidator.isValidParticipantsData(parsedData)) {
        ...
        const userParticipants = parsedData.participants.filter((p) => {
          var _a;
          return ((_a = p.humanInputMode) == null ? void 0 : _a.toUpperCase()) === "ALWAYS";
...
class TextMessageHandler {
   ...
   */
  canHandle(type) {
    return type === "text" || type === "tool_call" || type === "termination_and_human_reply_no_input" || type === "using_auto_reply";
  }
  /**
...
const _WaldiezChatMessageProcessor = class _WaldiezChatMessageProcessor {
  /**
  ...
  static process(rawMessage, requestId, imageUrl) {
    ...
    const data = _WaldiezChatMessageProcessor.parseMessage(message);
    if (!data) {
      return void 0;
    }
    const handler = _WaldiezChatMessageProcessor.findHandler(data.type);
    if (!handler) {
      return void 0;
    }
...
__publicField(_WaldiezChatMessageProcessor, "handlers", [
...
let WaldiezChatMessageProcessor = _WaldiezChatMessageProcessor;
const getCrypto = () => {
...
const getItemExtension = (itemType) => {
...
const downloadZip = async (filename, contents, onError) => {
  try {
...
const exportItem = async (name, itemType, exporter, onNoItem = () => {
...
const importItem = (event, itemGetter, onLoad) => {
  var _a;
...
const toCamelCase = (str) => {
  return str.replace(/([a-z])([A-Z])/g, "$1 $2").replace(/([0-9])([A-Z])/g, "$1 $2").replace(/_/g, " ").replace(/-/g, " ").trim().toLowerCase().split(" ").map((word) => capitalize(word)).join("").replace(/^[A-Z]/, (match) => match.toLowerCase());
};
class WaldiezAgent {
  constructor(props) {
    __publicField(this, "id");
    __publicField(this, "type", "agent");
...
const updateAgentDataProps = (agent, agentType) => {
...
const addRagUserProps = (agentData) => {
  agentData.retrieveConfig = {
    task: "default",
    vectorDb: "chroma",
    dbConfig: {
...
const addReasoningProps = (agentData) => {
  agentData.verbose = true;
  agentData.reasonConfig = {
    method: "beam_search",
    maxDepth: 3,
    forestSize: 1,
    ratingScale: 10,
...
const addCaptainProps = (agentData) => {
  agentData.agentLib = [];
  agentData.toolLib = null;
  agentData.maxRound = 10;
  agentData.maxTurns = 5;
};
const addGroupManagerProps = (agentData) => {
  agentData.groupName = "Group";
  agentData.maxRound = 20;
  agentData.adminName = null;
  agentData.contextVariables = {};
  agentData.enableClearHistory = false;
  agentData.sendIntroductions = false;
  agentData.initialAgentId = void 0;
  agentData.speakers = {
...
class WaldiezAgentAssistant extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "assistant");
...
class WaldiezAgentAssistantData extends WaldiezAgentData {
  constructor(props = {
    ...
    super(props);
    __publicField(this, "isMultimodal");
...
class WaldiezAgentCaptain extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "captain");
    this.data = props.data;
    this.agentType = "captain";
    this.rest = props.rest || {};
  }
}
class WaldiezAgentCaptainData extends WaldiezAgentData {
  constructor(props = {
    humanInputMode: "NEVER",
    systemMessage: null,
    codeExecutionConfig: false,
    ...
    super(props);
    __publicField(this, "agentLib");
    __publicField(this, "toolLib");
    __publicField(this, "maxRound");
...
class WaldiezAgentGroupManager extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "group_manager");
    this.agentType = "group_manager";
    this.data = props.data;
    this.rest = props.rest || {};
  }
}
class WaldiezAgentGroupManagerData extends WaldiezAgentData {
  constructor(props = {
    humanInputMode: "NEVER",
    systemMessage: null,
    codeExecutionConfig: false,
    ...
    enableClearHistory: void 0,
    sendIntroductions: void 0,
    groupName: void 0,
    initialAgentId: void 0
  }) {
    props.parentId = void 0;
    super(props);
    __publicField(this, "maxRound");
    __publicField(this, "adminName");
    __publicField(this, "speakers");
    __publicField(this, "enableClearHistory");
    __publicField(this, "sendIntroductions");
    __publicField(this, "groupName");
    __publicField(this, "initialAgentId");
    this.maxRound = props.maxRound;
...
class WaldiezAgentRagUser extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "rag_user_proxy");
    this.data = props.data;
    this.agentType = "rag_user_proxy";
    this.rest = props.rest || {};
  }
}
const defaultRetrieveConfig = {
  task: "default",
  vectorDb: "chroma",
  dbConfig: {
    model: "all-MiniLM-L6-v2",
...
class WaldiezAgentRagUserData extends WaldiezAgentData {
  constructor(props = {
    ...
    super(props);
    __publicField(this, "retrieveConfig");
...
let WaldiezAgentReasoning$1 = class WaldiezAgentReasoning extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "reasoning");
    this.data = props.data;
...
class WaldiezAgentReasoningData extends WaldiezAgentData {
  constructor(props = {
    humanInputMode: "NEVER",
    systemMessage: null,
    codeExecutionConfig: false,
    ...
    __publicField(this, "reasonConfig");
...
class WaldiezAgentUserProxy extends WaldiezAgent {
  constructor(props) {
    super(props);
    __publicField(this, "data");
    __publicField(this, "agentType", "user_proxy");
    this.agentType = "user_proxy";
    this.data = props.data;
    this.rest = props.rest || {};
  }
}
const ValidAgentTypes$2 = [
  "user_proxy",
  "assistant",
  "rag_user_proxy",
  "reasoning",
...
class WaldiezChatData {
  constructor(props = {
    ...
    __publicField(this, "sourceType");
    __publicField(this, "targetType");
    __publicField(this, "name");
    __publicField(this, "description");
    __publicField(this, "position");
    __publicField(this, "order");
    __publicField(this, "clearHistory");
    __publicField(this, "message");
    __publicField(this, "maxTurns");
    __publicField(this, "summary");
    __publicField(this, "nestedChat");
    __publicField(this, "prerequisites", []);
    __publicField(this, "realSource", null);
    __publicField(this, "realTarget", null);
    ...
    __publicField(this, "afterWork", null);
...
class WaldiezFlow {
  constructor(props) {
    ...
    __publicField(this, "version", "0.4.7");
    __publicField(this, "id");
    __publicField(this, "name");
    __publicField(this, "description");
    __publicField(this, "tags");
...
class WaldiezFlowData {
  constructor(props = {
    ...
    __publicField(this, "cacheSeed", 42);
    __publicField(this, "silent", false);
...
const getAgent = (agentType, id, name, description, tags, requirements, createdAt, updatedAt, data, rest) => {
  ...
  if (agentType === "reasoning") {
    return new WaldiezAgentReasoning$1({
      id,
      agentType,
      name,
      description,
...
const getNodePositionFromJSON = (nodeData, position) => {
  const nodePosition = { x: 20, y: 20 };
  if (position) {
    nodePosition.x = position.x;
    nodePosition.y = position.y;
  }
  if ("rest" in nodeData && typeof nodeData.rest === "object" && nodeData.rest && "position" in nodeData.rest && nodeData.rest.position) {
    if (typeof nodeData.rest.position === "object" && "x" in nodeData.rest.position && typeof nodeData.rest.position.x === "number" && "y" in nodeData.rest.position && typeof nodeData.rest.position.y === "number") {
      nodePosition.x = nodeData.rest.position.x;
      nodePosition.y = nodeData.rest.position.y;
    }
  } else if ("position" in nodeData && typeof nodeData.position === "object" && nodeData.position && "x" in nodeData.position && typeof nodeData.position.x === "number" && "y" in nodeData.position && typeof nodeData.position.y === "number") {
...
const getContextStrLLMCondition = (data) => {
  let condition = {
...
const getStringContextCondition = (data) => {
  let condition = {
...
const getExpressionContextCondition = (data) => {
  let condition = {
...
const getHandoffCondition = (data, defaultPrompt = "") => {
  let handoffCondition = {
    conditionType: "string_llm",
    prompt: defaultPrompt
  };
  if ("condition" in data && data.condition) {
    if (typeof data.condition === "object") {
      if ("conditionType" in data.condition && data.condition.conditionType && ValidConditionTypes.includes(data.condition.conditionType)) {
...
const isValidTransitionTarget = (obj) => {
  ...
  return "value" in target && Array.isArray(target.value) && target.value.every((t) => typeof t === "string");
};
const getAfterWork = (data) => {
  if ("afterWork" in data && typeof data.afterWork === "object" && data.afterWork && isValidTransitionTarget(data.afterWork)) {
    return data.afterWork;
  }
  return null;
};
const ValidAgentTypes$1 = [
  "user_proxy",
  "assistant",
  "captain",
  "rag_user_proxy",
...
const getAgentName = (data, agentType) => {
...
const getFallbackDescription = (agentType) => {
...
const getAgentMeta = (data, agentType) => {
...
const getHumanInputMode = (data, agentType) => {
  let humanInputMode = "NEVER";
  if (["user_proxy", "rag_user_proxy"].includes(agentType)) {
    humanInputMode = "ALWAYS";
  }
  if ("humanInputMode" in data && typeof data.humanInputMode === "string" && ["ALWAYS", "NEVER", "TERMINATE"].includes(data.humanInputMode)) {
    humanInputMode = data.humanInputMode;
  }
  return humanInputMode;
};
const getCodeExecutionConfig = (data) => {
  if ("codeExecutionConfig" in data && typeof data.codeExecutionConfig === "object" && data.codeExecutionConfig) {
    return data.codeExecutionConfig;
  }
  return false;
};
const getAgentDefaultAutoReply = (data) => {
  if ("agentDefaultAutoReply" in data && typeof data.agentDefaultAutoReply === "string") {
    return data.agentDefaultAutoReply;
  }
  return null;
};
const getMaximumConsecutiveAutoReply = (data) => {
...
const getTools$1 = (data) => {
  let tools = [];
  if ("tools" in data && Array.isArray(data.tools)) {
    tools = data.tools.filter(
      (tool) => typeof tool === "object" && tool && "id" in tool && "executorId" in tool && typeof tool.id === "string" && typeof tool.executorId === "string"
    );
  }
  return tools;
};
const getParentId = (data, _agentType) => {
  if ("parentId" in data && typeof data.parentId === "string") {
    return data.parentId;
  }
  return void 0;
};
const getNestedChatMessages = (chat) => {
  let messages = [];
  if ("messages" in chat && Array.isArray(chat.messages)) {
    messages = chat.messages.filter(
      (message) => typeof message === "object" && message && "id" in message && typeof message.id === "string" && "isReply" in message && typeof message.isReply === "boolean"
    );
  }
  return messages;
};
  ...
  if ("nestedChats" in data && Array.isArray(data.nestedChats)) {
    for (const chat of data.nestedChats) {
      ...
      if ("triggeredBy" in chat && Array.isArray(chat.triggeredBy)) {
        triggeredBy = chat.triggeredBy.filter((t) => typeof t === "string");
      }
...
const getContextVariables = (data) => {
  if ("contextVariables" in data && typeof data.contextVariables === "object") {
    return data.contextVariables;
  }
  return {};
};
const getUpdateAgentStateBeforeReply = (data) => {
  if ("updateAgentStateBeforeReply" in data && typeof data.updateAgentStateBeforeReply === "object" && data.updateAgentStateBeforeReply) {
    if ("type" in data.updateAgentStateBeforeReply && "content" in data.updateAgentStateBeforeReply) {
      if (typeof data.updateAgentStateBeforeReply.type === "string" && typeof data.updateAgentStateBeforeReply.content === "string") {
      ...
      return data.updateAgentStateBeforeReply.filter(
        (update) => typeof update === "object" && update && "type" in update && typeof update.type === "string" && "content" in update && typeof update.content === "string"
      );
    }
  }
  return [];
};
const getHandoffIds = (data) => {
...
const getReasonConfigMethod = (data) => {
  if ("method" in data && typeof data.method === "string" && ["beam_search", "mcts", "lats", "dfs"].includes(data.method)) {
    return data.method;
  }
  return "beam_search";
};
const getReasonConfigMaxDepth = (data) => {
  if ("maxDepth" in data && typeof data.maxDepth === "number") {
    return data.maxDepth;
  }
  return 3;
};
const getReasonConfigForestSize = (data) => {
  if ("forestSize" in data && typeof data.forestSize === "number") {
    return data.forestSize;
  }
  return 1;
};
const getReasonConfigRatingScale = (data) => {
  if ("ratingScale" in data && typeof data.ratingScale === "number") {
    return data.ratingScale;
  }
  return 10;
};
const getReasonConfigBeamSize = (data) => {
  if ("beamSize" in data && typeof data.beamSize === "number") {
    return data.beamSize;
  }
  return 3;
};
const getReasonConfigAnswerApproach = (data) => {
  if ("answerApproach" in data && typeof data.answerApproach === "string" && ["pool", "best"].includes(data.answerApproach)) {
    return data.answerApproach;
  }
  return "pool";
};
const getReasonConfigNsim = (data) => {
  if ("nsim" in data && typeof data.nsim === "number") {
    return data.nsim;
  }
  return 3;
};
const getReasonConfigExplorationConstant = (data) => {
...
const WaldiezThemeProvider = ({ children, initial }) => {
...
const agentMapper = {
   ...
   */
  exportAgent: (agentNode, skipLinks) => {
    const agentCopy = skipLinks ? removeLinks(agentNode) : { ...agentNode };
   ...
   */
  asNode: (agent, position, skipLinks) => {
    ...
    const agentNode = {
      ...
      data: nodeData,
      style: {
        width: agent.agentType === "group_manager" ? INITIAL_AGENT_SIZE.group_manager.width : agent.agentType !== "user_proxy" ? INITIAL_AGENT_SIZE.other.width : INITIAL_AGENT_SIZE.user.width
      },
      ...agent.rest,
      parentId: agent.data.parentId !== null ? agent.data.parentId : void 0,
...
const getAgentDataToImport = (jsonData, agentType) => {
...
const removeLinks = (agent) => {
  ...
  if (agent.data.agentType === "group_manager") {
    agentCopy.data.speakers = {
      ...agentCopy.data.speakers,
      allowRepeat: [],
      allowedOrDisallowedTransitions: {},
      order: []
    };
    agentCopy.data.initialAgentId = void 0;
  }
  return agentCopy;
};
const updateAgentDataToExport = (agentType, agentData, data) => {
  if (agentType === "rag_user_proxy") {
...
const updateReasoningAgent = (agentData, data) => {
  agentData.verbose = getVerbose(data);
  agentData.reasonConfig = getReasonConfig(data);
};
const updateCaptainAgent = (agentData, data) => {
...
const updateGroupManager = (agentData, data) => {
...
const getEdgeMessageContent = (data) => {
  let content = null;
...
const getEdgeMessageContext = (data) => {
  let context = {};
...
const getEdgeMessageUseCarryover = (data) => {
...
const getEdgeSummaryMethod = (data) => {
  let method = null;
...
const getEdgeSummaryPrompt = (data) => {
  let prompt = "";
...
const getChatClearHistory = (data) => {
...
const getChatPosition = (data, fallback) => {
...
const getChatPrerequisites = (data) => {
  const prerequisites = [];
...
const getChatType = (edge, json) => {
  ...
  let chatType = (edge == null ? void 0 : edge.type) ?? edgeType;
...
const updateEdge = (edge, chatData, json, sourceNode, targetNode, rest) => {
  ...
  edge.type = chatType;
  if (edge.type !== "hidden") {
    edge.animated = isChatAnimated(chatType);
  }
...
const updateChatCommonStyle = (edge, edgeType, color) => {
  ...
  edge.markerEnd = edgeType !== "nested" ? {
...
const setEdgeTargetHandle = (edge, rest) => {
...
const chatMapper = {
   ...
   */
  importChat: (json, edges, nodes, index) => {
    if (!json || typeof json !== "object") {
      throw new Error("Invalid edge data");
    }
    ...
    const data = getChatData(jsonObject.data, index);
    const rest = getChatRest({ ...jsonObject, ...edge });
    const updatedEdge = updateEdge(edge, data, jsonObject, sourceNode, targetNode, rest);
  ...
  asEdge: (chat) => {
    ...
    const style = ((_a = chat.rest) == null ? void 0 : _a.style) || {};
    style.strokeWidth = 1;
    return {
      id: chat.id,
      source: chat.source,
      ...
      type: chat.type,
      data,
      hidden: ((_b = chat.rest) == null ? void 0 : _b.hidden) === true || chat.type === "hidden",
      ...chat.rest,
      style
    };
  }
...
const getAgentNodes = (nodes) => {
  ...
  const userAgentNodes = agentNodes.filter(
    (node) => "data" in node && typeof node.data === "object" && node.data && "agentType" in node.data && node.data.agentType === "user_proxy"
  );
  const assistantAgentNodes = agentNodes.filter(
    (node) => "data" in node && typeof node.data === "object" && node.data && "agentType" in node.data && node.data.agentType === "assistant"
  );
  const ragUserNodes = agentNodes.filter(
    (node) => "data" in node && typeof node.data === "object" && node.data && "agentType" in node.data && node.data.agentType === "rag_user_proxy"
  );
  const reasoningAgentNodes = agentNodes.filter(
    (node) => "data" in node && typeof node.data === "object" && node.data && "agentType" in node.data && node.data.agentType === "reasoning"
  );
  const captainAgentNodes = agentNodes.filter(
    (node) => "data" in node && typeof node.data === "object" && node.data && "agentType" in node.data && node.data.agentType === "captain"
  );
...
const exportAgent = (agent, nodes, edges, skipLinks) => {
...
const getAgentNestedEdges = (agentId, agents, parentGroupId, edges) => {
  ...
  if (parentGroupId) {
    return agentEdges.filter((edge) => {
      ...
      return sourceAgent && targetAgent && sourceAgent.data.parentId === parentGroupId && targetAgent.data.parentId !== parentGroupId;
    });
  }
  return agentEdges.filter((edge) => edge.type === "nested");
};
const ensureAgentNestedChatData = (agent, nodes, edges) => {
...
const exportChat = (edge, edges, index) => {
...
const replaceModelSecrets = (modelNode) => {
...
const getFlowViewport = (data) => {
  let viewport = { zoom: 1, x: 0, y: 0 };
  if ("viewport" in data && typeof data.viewport === "object" && data.viewport && "zoom" in data.viewport && "x" in data.viewport && "y" in data.viewport && typeof data.viewport.zoom === "number" && typeof data.viewport.x === "number" && typeof data.viewport.y === "number") {
...
const getFlowAgents = (agentType, json, nodes, modelIds, toolIds, chatIds) => {
  ...
  nodes.forEach((node) => {
    if (node.type === "agent") {
      const agentJson = jsonEntries.find((agentJson2) => {
        return getIdFromJSON(agentJson2) === node.id;
      });
      if (agentJson) {
        const nodeExtras = { ...node };
...
const validateAgents = (agentType, imported, modelIds, toolIds, chatIds, nodeIds) => {
  const agents = imported.map((agent) => {
  ...
  if (agentType === "rag_user_proxy") {
    return filterRagUserProxyAgents(agents, modelIds);
  }
  return agents;
};
const filterAgentModelIds = (agent, modelIds) => {
  if (agent.data.modelIds) {
    agent.data.modelIds = agent.data.modelIds.filter((modelId) => modelIds.includes(modelId));
  }
  return agent;
};
const filterAgentTools = (agent, toolIds) => {
...
const filterAgentNestedChats = (agent, nodeIds, chatIds) => {
  agent.data.nestedChats = agent.data.nestedChats.filter(
    (nestedChat) => nestedChat.triggeredBy.some((trigger) => chatIds.includes(trigger) || nodeIds.includes(trigger))
  );
...
const filterRagUserProxyAgents = (agents, modelIds) => {
  return agents.map((agent) => {
    if ("data" in agent && typeof agent.data === "object" && "retrieveConfig" in agent.data && typeof agent.data.retrieveConfig === "object" && agent.data.retrieveConfig && "model" in agent.data.retrieveConfig && typeof agent.data.retrieveConfig.model === "string") {
  ...
  nodes.forEach((node) => {
    if (node.type === "model") {
      const modelJson = jsonModels.find((modelJson2) => {
        return getIdFromJSON(modelJson2) === node.id;
      });
      if (modelJson) {
        const nodeExtras = { ...node };
        delete nodeExtras.id;
...
const getNodePosition = (nodeJson) => {
  if (!("position" in nodeJson) || typeof nodeJson.position !== "object") {
    return null;
  }
  const position = nodeJson.position;
  if (!("x" in position) || typeof position.x !== "number" || !("y" in position) || typeof position.y !== "number") {
    return null;
  }
  return position;
};
const getNodeData = (nodeJson, type) => {
  const data = {};
  if (type === "agent") {
    const agentData = nodeJson.data || {};
    if (!("agentType" in agentData) || typeof agentData.agentType !== "string" || !ValidAgentTypes.includes(agentData.agentType)) {
      return data;
    }
...
const updateNodeLabel = (node, json) => {
  ...
  nodes.forEach((node) => {
    if (node.type === "tool") {
      const toolJson = jsonTools.find((toolJson2) => {
        return getIdFromJSON(toolJson2) === node.id;
      });
      if (toolJson) {
        const nodeExtras = { ...node };
        delete nodeExtras.id;
...
const getChats = (json, nodes, edges) => {
  ...
  const chats = [];
  const updatedEdges = [];
  json.chats.forEach((chatJson, index) => {
    try {
...
const flowMapper = {
   ...
   */
  importFlow: (item, newId) => {
    const flowJson = getFlowJson(item);
    if (!flowJson.type || flowJson.type !== "flow") {
      return emptyFlow;
    }
    const { id, storageId, name, description, tags, requirements, createdAt, updatedAt, rest } = importFlowMeta(flowJson);
    const flowData = flowJson.data || flowJson;
   ...
   */
  toReactFlow(flow) {
    const edges = getRFEdges(flow);
    const nodes = getRFNodes(flow);
    const flowProps = {
      flowId: flow.id,
  ...
  exportFlow: (flow, hideSecrets, skipLinks = false) => {
    const waldiezFlow = {
      ...
      tags: flow.tags,
      requirements: flow.requirements,
      createdAt: flow.createdAt || (/* @__PURE__ */ new Date()).toISOString(),
      updatedAt: flow.updatedAt || (/* @__PURE__ */ new Date()).toISOString(),
...
const getFlowDataToExport = (flow, hideSecrets, skipLinks) => {
  ...
  return new WaldiezFlowData({
    ...
    agents: {
      groupManagerAgents: groupManagerAgentNodes.map(
        (groupManagerAgentNode) => exportAgent(groupManagerAgentNode, nodes, edges, skipLinks)
      ),
      userProxyAgents: userAgentNodes.map(
        (userAgentNode) => exportAgent(userAgentNode, nodes, edges, skipLinks)
      ),
      assistantAgents: assistantAgentNodes.map(
        (assistantAgentNode) => exportAgent(assistantAgentNode, nodes, edges, skipLinks)
      ),
      ragUserProxyAgents: ragUserNodes.map(
        (ragUserNode) => exportAgent(ragUserNode, nodes, edges, skipLinks)
      ),
      reasoningAgents: reasoningAgentNodes.map(
        (reasoningAgentNode) => exportAgent(reasoningAgentNode, nodes, edges, skipLinks)
      ),
...
const getEdgeHandles = (flow, chat) => {
  var _a, _b;
  let sourceHandle;
  let targetHandle;
  if (((_a = chat.rest) == null ? void 0 : _a.sourceHandle) && typeof chat.rest.sourceHandle === "string") {
    sourceHandle = chat.rest.sourceHandle;
  }
  if (((_b = chat.rest) == null ? void 0 : _b.targetHandle) && typeof chat.rest.targetHandle === "string") {
    targetHandle = chat.rest.targetHandle;
  }
  if (!sourceHandle || !targetHandle) {
    const edge = flow.data.edges.find((edge2) => edge2.id === chat.id);
    if (edge) {
...
const _registerSnackbarEnqueue = (fn) => {
  globalEnqueue = fn;
};
const _unregisterSnackbarEnqueue = () => {
  globalEnqueue = null;
};
...
const Snackbar = ({
  ...
  useLayoutEffect(() => {
    ...
    const modalContent = root == null ? void 0 : root.querySelector("dialog[open] .modal-content");
    setContainer(modalContent instanceof HTMLElement ? modalContent : root);
  }, [flowId]);
  if (!container) {
    return null;
  }
  const getErrorMessage = (details2) => {
    if (details2 instanceof Error) {
      return details2.message;
    }
    if (typeof details2 === "string") {
      return details2;
    }
    if (typeof details2 === "object" && details2 !== null) {
      if ("detail" in details2 && typeof details2.detail === "string") {
        return details2.detail;
      }
      if ("message" in details2 && typeof details2.message === "string") {
        return details2.message;
      }
      if ("statusText" in details2 && typeof details2.statusText === "string") {
        return `Error: ${details2.statusText}`;
      }
      try {
        return JSON.stringify(details2, null, 2);
      } catch {
...
const SnackbarProvider = ({ children }) => {
  ...
  const enqueueSnackbar = useCallback((props) => {
    setQueues((qs) => {
      const id = Math.random().toString(36).slice(2);
      const flowId = props.flowId || "default";
      return {
        ...qs,
  ...
  const handleClose = useCallback((flowId) => {
  ...
  useEffect(() => {
    Object.entries(active).forEach(([flowId, snackbar]) => {
      ...
      if (!withCloseButton || duration !== void 0) {
...
const calculateNewNodePosition = (rfInstance, flowWrapper, currentNodesCount, entriesDistance) => {
  const zoom = (rfInstance == null ? void 0 : rfInstance.getZoom()) ?? 1;
...
const InfoCheckbox = memo((props) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "info-checkbox-container", children: /* @__PURE__ */ jsxs("div", { className: "info-checkbox-wrapper", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "info-label margin-left--10", children: [
      /* @__PURE__ */ jsx(FaInfoCircle, { className: "info-checkbox-icon" }),
      /* @__PURE__ */ jsx("div", { className: "info-description", children: infoElement })
    ] })
  ] }) });
});
...
const targetsToLabelsMapping = {
  ...
  // assuming? the afterWork is for an agent and: either not in a group chat or a second group chat exists
  NestedChatTarget: "Trigger a nested chat",
  // assuming a nested exists
  GroupManagerTarget: "Return to the group chat manager",
  // assuming? the afterWork is for an agent that is a member of a group chat
  StayTarget: "Do Nothing"
  // why is this needed?
};
const AfterWork = memo(
  ({ target, agents, onChange, isForGroupChat = true }) => {
    const [enabled, setEnabled] = useState(!!target);
    const [selectedTargetType, setSelectedTargetType] = useState(
      target == null ? void 0 : target.targetType
    );
    const [selectedAgentTargetId, setSelectedAgentTargetId] = useState(
      (target == null ? void 0 : target.targetType) === "AgentTarget" ? target.value[0] : void 0
    );
    const [selectedRandomAgentTargetIds, setSelectedRandomAgentTargetIds] = useState(
      (target == null ? void 0 : target.targetType) === "RandomAgentTarget" ? target.value : []
    );
    ...
    const selectedAgentOption = useMemo(
      () => {
        var _a;
        return {
          label: (_a = agentTargetOptions.find((option) => option.value === selectedAgentTargetId)) == null ? void 0 : _a.label,
    ...
    const onTargetTypeChange = useCallback(
      (selectedOption) => {
        if (!(selectedOption == null ? void 0 : selectedOption.value)) {
          return;
        }
    ...
    const onAgentTargetChange = useCallback(
      (selectedOption) => {
        if (!(selectedOption == null ? void 0 : selectedOption.value) || selectedTargetType !== "AgentTarget") {
          return;
        }
          ...
          /* @__PURE__ */ jsx(
            Select,
            {
              ...
              value: selectedRandomAgentTargetIds.map((id) => {
                var _a;
                return {
                  label: (_a = agentTargetOptions.find((option) => option.value === id)) == null ? void 0 : _a.label,
                  value: id
                };
              }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: `image-modal ${isOpen ? "open" : ""}`, onClick: onClose, "data-testid": "modal-overlay", children: [
    ...
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx(FaX, {})
      }
    )
  ] });
};
const useImageRetry = (maxRetries = 3, retryDelay = 1e3) => {
  const retries = useRef(/* @__PURE__ */ new Map());
...
const ImageWithRetry = ({ src, alt = "Chat image", className, onClick }) => {
...
const isReactElementWithProps = (node) => {
  return React__default.isValidElement(node) && typeof node.props === "object" && node.props !== null;
};
...
const ChatUI = ({ messages, isDarkMode, userParticipants }) => {
  ...
  const getMessageKey = useCallback((msg, index) => {
  ...
  useEffect(() => {
    ...
    const scrollToBottom = () => {
      ...
      if (container) {
        ...
        scrollableContainers.forEach((container2) => {
    ...
    /* @__PURE__ */ jsx("div", { className: "chat-container", ref: chatContainer, children: messages.map((msg, index) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "message-header", children: [
...
const useDict = (props) => {
  ...
  const [stateItems, setStateItems] = useState(Object.entries(items));
  ...
  const onKeyChange = useCallback((index, event) => {
    const newKey = event.target.value;
    setStateItems(
      (prevItems) => prevItems.map(([key, value], idx) => idx === index ? [newKey, value] : [key, value])
    );
  }, []);
  const onValueChange = useCallback((index, event) => {
    const newValue = event.target.value;
    setStateItems(
      (prevItems) => prevItems.map(([key, value], idx) => idx === index ? [key, newValue] : [key, value])
    );
  }, []);
  ...
  const onNewEntryKeyChange = useCallback((event) => {
    const newKey = event.target.value;
    setNewEntry((prev) => ({ ...prev, key: newKey }));
  }, []);
  const onNewEntryValueChange = useCallback((event) => {
    const newValue = event.target.value;
  ...
  const onSaveEntry = useCallback(() => {
    const itemsToSend = stateItems.reduce((acc, [key, value]) => {
      acc[key] = value;
      return acc;
    }, {});
...
const InfoLabel = (props) => {
  ...
  const labelElement = typeof label === "function" ? label() : label;
  const infoElement = typeof info === "function" ? info() : info;
  return /* @__PURE__ */ jsxs("div", { className: "info-label", children: [
    /* @__PURE__ */ jsx("label", { htmlFor, children: labelElement }),
    /* @__PURE__ */ jsx(FaInfoCircle, { className: "info-icon" }),
    /* @__PURE__ */ jsx(
      "div",
      {
        className: "info-description",
        children: infoElement
      }
    )
  ] });
};
...
const Dict = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dict-entries-view", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "dict-entries-list", children: Object.entries(items).map(([key, value], index) => /* @__PURE__ */ jsxs("div", { className: "dict-entry", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
...
const useDropZone = (props) => {
  const { flowId, onUpload, allowedFileExtensions: allowedFileExtensions2, multiple = false } = props;
  const isValidFile = useCallback(
    (file) => {
      var _a;
      const extension = (_a = file.name.split(".").pop()) == null ? void 0 : _a.toLowerCase();
      if (!extension || !allowedFileExtensions2.some((ext) => ext.toLowerCase() === `.${extension}`)) {
        showSnackbar({
          flowId,
  ...
  const filterValidFiles = useCallback(
    (fileList) => {
      return Array.from(fileList).filter(
        (file) => allowedFileExtensions2.some((ext) => file.name.toLowerCase().endsWith(ext.toLowerCase()))
      );
    },
    [allowedFileExtensions2]
  );
  ...
  const onOpenUploadDialog = useCallback(() => {
    ...
    input.accept = allowedFileExtensions2.join(",");
    ...
    input.click();
  }, [multiple, allowedFileExtensions2, filterValidFiles, handleUpload]);
  return {
    onFileDragOver,
    onFileDragLeave,
    onFileDrop,
...
const TextareaInput = ({ value, onChange, autoFocus = false, ...props }) => {
  const ref = useRef(null);
  const cursorPositionRef = useRef({
    selectionStart: (value == null ? void 0 : value.length) || 0,
    selectionEnd: (value == null ? void 0 : value.length) || 0
  });
...
const HandoffAvailability = (props) => {
...
const HandoffCondition = (props) => {
  const { condition, onDataChange } = props;
  const [currentHandoffCondition, setCurrentHandoffCondition] = useState(condition);
  useEffect(() => {
  ...
  const selectedTypeOption = useMemo(
    () => (currentHandoffCondition == null ? void 0 : currentHandoffCondition.conditionType) ? {
  ...
  const renderConditionInput = useCallback(() => {
    if (!(currentHandoffCondition == null ? void 0 : currentHandoffCondition.conditionType)) {
      return null;
    }
...
const useAgentRelationships = (id, data, agents, edges) => {
  ...
  const nestedEdges = useMemo(() => {
    return agentEdges.filter((edge) => {
      const sourceAgent = agents.find((agent) => agent.id === edge.source);
      const targetAgent = agents.find((agent) => agent.id === edge.target);
      return sourceAgent && targetAgent && sourceAgent.id === id && // source is the current agent
      sourceAgent.data.parentId === parentGroupId && targetAgent.data.parentId !== parentGroupId;
    });
  ...
  const nestedChats = useMemo(() => {
    const existingChats = data.nestedChats || [];
    ...
    return [
      {
        triggeredBy: [id],
        // always the source is the agent (it's FROM the agent TO one or more non-group members)
        messages: nestedEdges.map((edge) => ({ id: edge.id, isReply: false })),
        // the messages are gathered from the edges (the targets)
        condition: {
          conditionType: "string_llm",
          prompt: ""
        },
...
const useHandoffNames = (agents, allEdges, nestedChats) => {
  const getAgentName2 = useCallback(
    (agentId) => {
      const agent = agents.find((a) => a.id === agentId);
      return (agent == null ? void 0 : agent.data.label) || (agent == null ? void 0 : agent.data.name) || agentId;
    },
    [agents]
  );
  const getNestedChatDisplayName = useCallback(
    (index = 0) => {
      ...
      return targets.length === 1 ? `Nested Chat: ${targets[0]}` : `Nested Chat: ${targets[0]} +${targets.length - 1} more`;
    },
    [nestedChats, allEdges, getAgentName2]
  );
  ...
  const getAfterWorkTargetName = (target) => {
...
const useHandoffs = (id, data, agents, edges, onDataChange) => {
  ...
  const orderedTransitionTargets = useMemo(() => {
    ...
    data.handoffs.forEach((id2, index) => {
      if (id2 === nestedChatId) {
        if (hasNestedChat) {
          const newTarget = {
        ...
        const edge = groupEdges.find((e) => e.id === id2);
        if (edge) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "handoffs-container", "data-testid": `handoffs-container-${id}`, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "handoffs-list", children: !hasHandoffs ? /* @__PURE__ */ jsx("div", { className: "no-handoffs-message", children: `This agent has no handoffs configured. You can add connections to other agents in the flow editor, configure nested chats in the agent settings, or set what happens after the agent's work is done in the "Afterwards" tab.` }) : /* @__PURE__ */ jsxs("div", { className: "handoffs-items", children: [
      orderedTransitionTargets.length > 0 && /* @__PURE__ */ jsxs("div", { className: "handoffs-section", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "ordered-items-list", children: orderedTransitionTargets.map((item, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "reorder-buttons", children: [
                ...
                index < orderedTransitionTargets.length - 1 && /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
                    title: "Move down",
              ...
              /* @__PURE__ */ jsxs("div", { className: "ordered-item-content", children: [
                /* @__PURE__ */ jsx("div", { className: "order-badge", children: index + 1 }),
...
const useMessageInput = (props) => {
  ...
  const onAddContextEntry = useCallback(
    (key, value) => {
      handleAddContextEntry == null ? void 0 : handleAddContextEntry(key, value);
    },
    [handleAddContextEntry]
  );
  const onRemoveContextEntry = useCallback(
    (key) => {
      handleRemoveContextEntry == null ? void 0 : handleRemoveContextEntry(key);
    },
    [handleRemoveContextEntry]
  );
  const onUpdateContextEntries = useCallback(
    (entries) => {
      handleUpdateContextEntries == null ? void 0 : handleUpdateContextEntries(entries);
    },
...
const MessageInput = (props) => {
  ...
  let selectOptions = skipRagOption ? messageTypeOptions.filter((option) => option.value !== "rag_message_generator") : messageTypeOptions;
  if (skipNone === true) {
...
const Modal = memo((props) => {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      (_b = modalRef.current) == null ? void 0 : _b.close();
    }
  }, [isOpen]);
  useLayoutEffect(() => {
  ...
  const checkTabSpaceAndResize = useCallback(() => {
    ...
    const tabList = modalRef.current.querySelector(".tab-list");
    if (!tabList) {
      return;
    }
...
const NumberInput = memo((props) => {
  ...
  const renderLabel = useMemo(() => {
    ...
    if (labelInfo) {
      return /* @__PURE__ */ jsx("div", { className: "number-input-info-label-wrapper", children: /* @__PURE__ */ jsx(
        InfoLabel,
        {
          label: /* @__PURE__ */ jsxs("div", { className: "number-input-info-label-inner", children: [
            label,
            "  ",
            labelValue
          ] }),
...
const resetSyncEdgeOrders = (get, set) => {
  ...
  const newEdges = edges.map((edge, index) => {
    var _a;
    let edgeOrder = (_a = edge.data) == null ? void 0 : _a.order;
    if (edgeOrder === void 0) {
      edgeOrder = -1;
    }
    return {
...
const resetAsyncEdgeOrders = (get, set) => {
  const usedEdges = get().edges.filter(
    (edge) => {
      var _a;
      return ((_a = edge.data) == null ? void 0 : _a.order) !== void 0 && edge.data.order >= 0;
    }
  );
...
const resetEdgePrerequisites = (edges, get, set) => {
  ...
  const computeOrder = (edge) => {
    ...
    return Math.max(
      ...edge.data.prerequisites.map((id) => {
        ...
        return ((_a2 = edge2 == null ? void 0 : edge2.data) == null ? void 0 : _a2.order) ?? 0;
      })
    ) + 1;
  };
  let changed = true;
  while (changed) {
    ...
    for (const edge of edges) {
      ...
      if (((_a = edgesMap.get(edge.id).data) == null ? void 0 : _a.order) !== newOrder) {
...
const selectivelyOverrideOrMergeFlow = (items, currentFlow, newFlow, typeShown, mergedFlow) => {
  ...
  const itemNodeIds = itemNodes.map((node) => node.id);
...
class WaldiezAgentStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "getAgents", () => {
      return this.get().nodes.filter((node) => node.type === "agent");
    });
    /**
     ...
     */
    __publicField(this, "getAgentById", (id) => {
     ...
     */
    __publicField(this, "addAgent", (agentType, position, parentId) => {
     ...
     */
    __publicField(this, "cloneAgent", (id) => {
      const agent = this.get().nodes.find((node) => node.id === id);
      if (agent) {
     ...
     */
    __publicField(this, "updateAgentData", (id, data) => {
      this.set({
        nodes: this.get().nodes.map((node) => {
          if (node.id === id) {
            if (data.parentId !== node.data.parentId) {
              node.parentId = data.parentId ?? void 0;
              node.extent = data.parentId ? "parent" : void 0;
            }
            return {
              ...node,
              data: { ...node.data, ...data }
     ...
     */
    __publicField(this, "deleteAgent", (id) => {
      const agent = this.get().nodes.find((node) => node.id === id);
      if (agent) {
        ...
        this.set({
          nodes: this.get().nodes.filter((node) => !idsToRemove.includes(node.id)).map((node) => {
            if (idsToResetParent.includes(node.id)) {
              node.parentId = void 0;
              node.data.parentId = void 0;
              node.extent = void 0;
            }
            return node;
          }),
     ...
     */
    __publicField(this, "importAgent", (agent, agentId, skipLinks, position, save = true) => {
     ...
     */
    __publicField(this, "exportAgent", (agentId, hideSecrets) => {
     ...
     */
    __publicField(this, "getAgentConnections", (nodeId, options) => {
      if (!options) {
        options = {
          sourcesOnly: false,
          targetsOnly: false
     ...
     */
    __publicField(this, "setAgentGroup", (agentId, groupId, position) => {
      this.set({
        nodes: this.get().nodes.map((node) => {
          if (node.id === agentId) {
            return {
     ...
     */
    __publicField(this, "getGroupMembers", (groupId) => {
     ...
     */
    __publicField(this, "addGroupMember", (groupId, memberId, position) => {
      this.set({
        nodes: this.get().nodes.map((node) => {
          if (node.id === memberId) {
            return {
     ...
     */
    __publicField(this, "removeGroupMember", (groupId, memberId) => {
      const nodes = [
...
class WaldiezEdgeStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "getEdges", () => this.get().edges);
    /**
     ...
     */
    __publicField(this, "getEdgeById", (id) => {
     ...
     */
    __publicField(this, "deleteEdge", (id) => {
      const agents = this.get().nodes.filter((node) => node.type === "agent");
     ...
     */
    __publicField(this, "updateEdgeData", (id, data) => {
      const edge = this.get().edges.find((edge2) => edge2.id === id);
      if (edge) {
     ...
     */
    __publicField(this, "updateEdgeType", (id, edgeType) => {
      this.set({
          ...
          if (edge.id === id) {
            ...
            return {
              ...
              data: {
                ...edge.data,
                type: edgeType,
                order: edgeType === "nested" ? -1 : ((_a = edge.data) == null ? void 0 : _a.order) ?? -1,
                prerequisites: edgeType === "nested" ? [] : ((_b = edge.data) == null ? void 0 : _b.prerequisites) ?? []
              },
     ...
     */
    __publicField(this, "updateEdgePath", (id, agentType) => {
     ...
     */
    __publicField(this, "addEdge", (options) => {
     ...
     */
    __publicField(this, "onEdgeDoubleClick", (_event, edge) => {
     ...
     */
    __publicField(this, "getEdgeSourceAgent", (edge) => {
     ...
     */
    __publicField(this, "getEdgeTargetAgent", (edge) => {
     ...
     */
    __publicField(this, "onReconnect", (oldEdge, newConnection) => {
      var _a;
      const nodes = this.get().nodes;
      ...
      const oldLabel = (_a = oldEdge.data) == null ? void 0 : _a.label;
     ...
     */
    __publicField(this, "onEdgesChange", (changes) => {
     ...
     */
    __publicField(this, "resetEdgeOrdersAndPositions", () => {
      resetEdgeOrdersAndPositions(this.get, this.set);
    });
    this.get = get;
    this.set = set;
...
class WaldiezFlowStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "getViewport", () => this.get().viewport);
    /**
     ...
     */
    __publicField(this, "getRfInstance", () => this.get().rfInstance);
    /**
     ...
     */
    __publicField(this, "setRfInstance", (instance) => {
     ...
     */
    __publicField(this, "getFlowInfo", () => {
      const {
        flowId,
        storageId,
        name,
     ...
     */
    __publicField(this, "onFlowChanged", () => {
     ...
     */
    __publicField(this, "getFlowEdges", () => {
      ...
      allEdges.forEach((edge) => {
        var _a;
        let edgeOrder;
        if (typeof ((_a = edge.data) == null ? void 0 : _a.order) === "number") {
      ...
      const sortedEdgesUsed = usedEdges.sort((a, b) => {
        var _a, _b;
        return (((_a = a.data) == null ? void 0 : _a.order) ?? 0) - (((_b = b.data) == null ? void 0 : _b.order) ?? 0);
      });
     ...
     */
    __publicField(this, "onViewportChange", (viewport, nodeType) => {
      var _a;
      if (nodeType === "model" || nodeType === "tool") {
        const zoomChanged = viewport.zoom !== ((_a = this.get().viewport) == null ? void 0 : _a.zoom);
        if (zoomChanged) {
     ...
     */
    __publicField(this, "importFlow", (items, flowData, typeShown) => {
      const {
        storageId,
        name: currentName,
      ...
      reArrangeTools(this.get, this.set);
      setTimeout(() => {
        rfInstance == null ? void 0 : rfInstance.fitView({
     ...
     */
    __publicField(this, "exportFlow", (hideSecrets) => {
      const {
        isAsync,
        cacheSeed,
        viewport,
      ...
      const flow = {
        ...
        viewport: (rfInstance == null ? void 0 : rfInstance.getViewport()) ?? viewport ?? { zoom: 1, x: 20, y: 20 },
        name: name ?? "Untitled Flow",
        description: description ?? "A new Waldiez flow",
        tags: tags ?? [],
        requirements: requirements ?? [],
     ...
     */
    __publicField(this, "updateFlowOrder", (data) => {
      const updatedAt = (/* @__PURE__ */ new Date()).toISOString();
      this.set({
        edges: this.get().edges.map((edge) => {
          var _a, _b;
          const order = ((_a = data.find((d) => d.id === edge.id)) == null ? void 0 : _a.order) ?? ((_b = edge.data) == null ? void 0 : _b.order) ?? -1;
          return {
            ...edge,
     ...
     */
    __publicField(this, "updateFlowPrerequisites", (edges) => {
     ...
     */
    __publicField(this, "updateFlowInfo", (data) => {
      this.set({
        name: data.name,
        description: data.description,
        tags: data.tags,
...
class WaldiezModelStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "getModels", () => {
      return this.get().nodes.filter((node) => node.type === "model");
    });
    /**
     ...
     */
    __publicField(this, "getModelById", (id) => {
     ...
     */
    __publicField(this, "cloneModel", (id) => {
      const model = this.get().nodes.find((node) => node.id === id);
      if (!model || model.type !== "model") {
        return null;
      }
     ...
     */
    __publicField(this, "updateModelData", (id, data) => {
      const model = this.get().nodes.find((node) => node.id === id);
      if (!model || model.type !== "model") {
        return;
      }
     ...
     */
    __publicField(this, "deleteModel", (id) => {
      const rfInstance = this.get().rfInstance;
     ...
     */
    __publicField(this, "importModel", (model, modelId, position, save = true) => {
     ...
     */
    __publicField(this, "exportModel", (modelId, hideSecrets) => {
    ...
    __publicField(this, "getClonedModel", (modelId, rfInstance) => {
      const model = this.get().nodes.find((node) => node.id === modelId);
      if (!model) {
        throw new Error(`Model with id ${modelId} not found`);
      }
     ...
     */
    __publicField(this, "getNodesAfterModelDeletion", (modelId, rfInstance) => {
...
class WaldiezNodeStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "showNodes", (nodeType) => {
      if (nodeType !== "agent") {
     ...
     */
    __publicField(this, "isShowingAgents", () => {
     ...
     */
    __publicField(this, "storePreviousViewport", () => {
      const rfInstance = this.get().rfInstance;
     ...
     */
    __publicField(this, "restorePreviousViewport", () => {
     ...
     */
    __publicField(this, "onNodesChange", (changes) => {
     ...
     */
    __publicField(this, "onNodeDoubleClick", (_event, node) => {
      const openDialogs = document.querySelectorAll("dialog[open]");
      if (openDialogs.length > 0) {
        return;
      }
      ...
      const flowRoot = getFlowRoot(flowId);
      if (flowRoot) {
        const openModalBtn = flowRoot.querySelector(`[data-node-id="${node.id}"]`);
        if (openModalBtn) {
          openModalBtn.click();
        }
      }
     ...
     */
    __publicField(this, "reselectNode", (id) => {
     ...
     */
    __publicField(this, "highlightNode", (nodeId) => {
      this.set({
        nodes: this.get().nodes.map((node) => ({
          ...node,
     ...
     */
    __publicField(this, "clearNodeHighlight", () => {
      this.set({
        nodes: this.get().nodes.map((node) => ({
          ...node,
          className: ""
...
class WaldiezToolStore {
  ...
  constructor(get, set) {
     ...
     */
    __publicField(this, "getTools", () => {
      return this.get().nodes.filter((node) => node.type === "tool");
    });
    /**
     ...
     */
    __publicField(this, "getToolById", (id) => {
     ...
     */
    __publicField(this, "cloneTool", (id) => {
      const tool = this.get().nodes.find((node) => node.id === id);
      if (!tool || tool.type !== "tool") {
        return null;
      }
     ...
     */
    __publicField(this, "updateToolData", (id, data) => {
      const tool = this.get().nodes.find((node) => node.id === id);
      if (!tool || tool.type !== "tool") {
        return;
      }
     ...
     */
    __publicField(this, "deleteTool", (id) => {
      const rfInstance = this.get().rfInstance;
     ...
     */
    __publicField(this, "importTool", (tool, toolId, position, save) => {
     ...
     */
    __publicField(this, "exportTool", (toolId, hideSecrets) => {
     ...
     */
    __publicField(this, "getClonedTool", (tool, rfInstance) => {
     ...
     */
    __publicField(this, "getAgentAfterToolDeletion", (toolId, agent) => {
     ...
     */
    __publicField(this, "getAgentsAfterToolDeletion", (toolId, rfInstance) => {
      ...
      allNodes.forEach((node) => {
        if (node.type === "agent") {
          const agent = this.getAgentAfterToolDeletion(toolId, node);
          newNodes.push(agent);
        } else {
          newNodes.push(node);
        }
...
const createWaldiezStore = (props) => {
  ...
  return createStore()(
    temporal(
      (set, get) => ({
        rfInstance: props == null ? void 0 : props.rfInstance,
        flowId,
        isAsync,
        isReadOnly,
        skipExport,
...
const useDnD = (onNewAgent) => {
  ...
  const getParentPosition = useCallback(
    (parent) => {
      ...
      if (parentPos == null ? void 0 : parentPos.internals.positionAbsolute) {
        return {
  ...
  const addAgentNode = useCallback(
    (event, agentType) => {
      ...
      const newNode = addAgent(agentType, position, parent == null ? void 0 : parent.id);
      if (parent) {
...
const useKeys = (flowId, onSave) => {
  ...
  const onKeyDown = (event) => {
    ...
    if ((event == null ? void 0 : event.key) === "Delete" || (event == null ? void 0 : event.key) === "Backspace") {
      if (isFlowVisible()) {
        onDeleteKey(event);
      }
    }
...
const useFlowEvents = (flowId) => {
  ...
  const exportFlow2 = useWaldiez((s) => s.exportFlow);
  ...
  const onExport = useCallback(
    ...
    [isReadOnly, getFlowInfo, exportFlow2, flowId]
  );
  return useMemo(
    () => ({
      convertToPy,
...
const ChatModal = memo((props) => {
  ...
  useEffect(() => {
    if (chat == null ? void 0 : chat.showUI) {
      setTextInput("");
      setImagePreview(null);
      requestAnimationFrame(() => {
        var _a2, _b2, _c2;
        if ((_a2 = chat.activeRequest) == null ? void 0 : _a2.request_id) {
          (_b2 = inputRef.current) == null ? void 0 : _b2.focus();
        } else {
          (_c2 = inputRef.current) == null ? void 0 : _c2.blur();
        }
      });
    }
  }, [chat == null ? void 0 : chat.showUI, (_a = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _a.request_id, chat == null ? void 0 : chat.messages]);
  const createInputResponse = useCallback(
    (includeData = true) => {
      ...
      return {
        id: `${flowId}-${Date.now()}`,
        request_id: ((_a2 = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _a2.request_id) || "",
        type: "input_response",
        timestamp: (/* @__PURE__ */ new Date()).toISOString(),
        data
      };
    },
    [flowId, chat == null ? void 0 : chat.activeRequest, textInput, imagePreview]
  );
  const handleSubmit = useCallback(() => {
    var _a2, _b2;
    (_b2 = (_a2 = chat == null ? void 0 : chat.handlers) == null ? void 0 : _a2.onUserInput) == null ? void 0 : _b2.call(_a2, createInputResponse());
    setTimeout(() => {
      setTextInput("");
      setImagePreview(null);
    }, 10);
  }, [chat == null ? void 0 : chat.handlers, createInputResponse]);
  ...
  const handleClose = useCallback(() => {
    ...
    setTextInput("");
    setImagePreview(null);
    (_b2 = (_a2 = chat == null ? void 0 : chat.handlers) == null ? void 0 : _a2.onClose) == null ? void 0 : _b2.call(_a2);
  }, [chat == null ? void 0 : chat.handlers]);
  ...
  const isModalOpen = (chat == null ? void 0 : chat.showUI) === true || chat !== void 0 && chat.messages.length > 0;
  const leftIcon = ((_b = chat == null ? void 0 : chat.handlers) == null ? void 0 : _b.onInterrupt) ? /* @__PURE__ */ jsx(
    "div",
    {
      role: "button",
  ...
  const allowImage = !chat || !(chat == null ? void 0 : chat.mediaConfig) ? true : (_c = chat == null ? void 0 : chat.mediaConfig) == null ? void 0 : _c.allowedTypes.includes("image");
  return /* @__PURE__ */ jsx(
    Modal,
    {
      id: modalTestId,
      ...
      hasMaximizeBtn: true,
      hasCloseBtn: (chat == null ? void 0 : chat.showUI) === false,
      dataTestId: modalTestId,
      children: /* @__PURE__ */ jsxs("div", { className: "modal-body", children: [
        (chat == null ? void 0 : chat.messages) && chat.messages.length > 0 && /* @__PURE__ */ jsx("div", { className: "chat-wrapper", "data-flow-id": flowId, children: /* @__PURE__ */ jsx(
          ChatUI,
          {
            isDarkMode: false,
        ...
        /* @__PURE__ */ jsx("div", { className: "input-prompt", children: (_d = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _d.prompt }),
        ((_e = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _e.request_id) !== void 0 && /* @__PURE__ */ jsxs("div", { className: "chat-input-container", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "chat-input-field-container", children: ((_f = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _f.password) === true ? /* @__PURE__ */ jsxs("div", { className: "password-toggle-container", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                "data-testid": inputId,
                value: textInput,
                disabled: ((_g = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _g.request_id) === void 0,
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                disabled: ((_h = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _h.request_id) === void 0,
            ...
            "input",
            {
              ...
              "data-testid": inputId,
              value: textInput,
              disabled: ((_i = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _i.request_id) === void 0,
              onKeyDown: handleKeyDown,
              onChange: handleTextChange,
          ...
          ((_j = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _j.request_id) !== void 0 && /* @__PURE__ */ jsxs("div", { className: "chat-input-actions", children: [
            allowImage ? /* @__PURE__ */ jsxs("label", { htmlFor: imageInputId, className: "chat-upload-button", children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  type: "file",
                  disabled: ((_k = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _k.request_id) === void 0,
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
                title: "Send",
                disabled: ((_l = chat == null ? void 0 : chat.activeRequest) == null ? void 0 : _l.request_id) === void 0,
...
const SNACKBAR_DURATION = 5e3;
const ExportFlowModal = memo((props) => {
  ...
  const onAlsoUploadChange = useCallback((checked) => {
    setAlsoUpload(checked);
  }, []);
  const onHubApiTokenChange = useCallback((e) => {
...
const useImportFlowModal = (props) => {
  const { onClose: handleClose, typeShown, onTypeShownChange } = props;
  const [importFlowState, setImportFlowState] = useState(initialState);
  const importFlow2 = useWaldiez((s) => s.importFlow);
  const onFlowChanged = useWaldiez((s) => s.onFlowChanged);
  const onSubmit = useCallback(() => {
    const { loadedFlowData, selectedProps } = importFlowState;
    if (loadedFlowData) {
      importFlow2(selectedProps, loadedFlowData, typeShown);
      onTypeShownChange("agent");
      onFlowChanged();
    }
  }, [importFlowState, importFlow2, typeShown, onTypeShownChange, onFlowChanged]);
  ...
  const onImportFlowStateChange = useCallback((newState) => {
...
const useFlowAgents = (props) => {
  ...
  const agentNodes = useMemo(
    () => (flowData == null ? void 0 : flowData.nodes.filter((node) => node.type === "agent")) || [],
    [flowData == null ? void 0 : flowData.nodes]
  );
  const onSelectedPropsChange = useCallback(
    (thingsToImport) => {
      onStateChange({
    ...
    (node) => {
      ...
      onSelectedPropsChange({
        nodes: {
          ...
          agents: isSelected ? selectedProps.nodes.agents.filter((agent) => agent.id !== node.id) : [...selectedProps.nodes.agents, node]
        }
      });
    },
...
const useFlowModels = (props) => {
  const { flowId, state, onStateChange } = props;
  const { selectedProps, loadedFlowData: flowData } = state;
  const modelNodes = useMemo(
    () => (flowData == null ? void 0 : flowData.nodes.filter((node) => node.type === "model")) || [],
    [flowData == null ? void 0 : flowData.nodes]
  );
  const onSelectedPropsChange = useCallback(
    (thingsToImport) => {
  ...
  const onModelsChange = useCallback(
    (node) => {
      ...
      onSelectedPropsChange({
        nodes: {
          models: isSelected ? selectedProps.nodes.models.filter((model) => model.id !== node.id) : [...selectedProps.nodes.models, node],
          tools: selectedProps.nodes.tools,
...
const useFlowTools = (props) => {
  const { flowId, state, onStateChange } = props;
  const { selectedProps, loadedFlowData: flowData } = state;
  const toolNodes = useMemo(
    () => (flowData == null ? void 0 : flowData.nodes.filter((node) => node.type === "tool")) || [],
    [flowData == null ? void 0 : flowData.nodes]
  );
  const onSelectedPropsChange = useCallback(
    (thingsToImport) => {
  ...
  const onToolsChange = useCallback(
    (node) => {
      ...
      onSelectedPropsChange({
        nodes: {
          models: selectedProps.nodes.models,
          tools: isSelected ? selectedProps.nodes.tools.filter((tool) => tool.id !== node.id) : [...selectedProps.nodes.tools, node],
          agents: selectedProps.nodes.agents
        }
      });
    },
...
const FlowAgents = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flow-data-preview-body-section", children: [
    ...
    agentNodes && (agentNodes == null ? void 0 : agentNodes.length) > 1 && /* @__PURE__ */ jsx("div", { className: "flow-data-preview-body-section-row", children: /* @__PURE__ */ jsx(
      CheckboxInput,
      {
    ...
    agentNodes == null ? void 0 : agentNodes.map((node) => {
    ...
    (agentNodes == null ? void 0 : agentNodes.length) === 0 && /* @__PURE__ */ jsx("div", { children: "No agents in this flow" })
  ] });
};
const FlowInfo = (props) => {
  const { flowId, state } = props;
  const { loadedFlowData: flowData, selectedProps } = state;
  const tagsString = (flowData == null ? void 0 : flowData.tags.length) ? flowData == null ? void 0 : flowData.tags.join(", ") : "None";
  const requirementsString = (flowData == null ? void 0 : flowData.requirements.length) ? flowData == null ? void 0 : flowData.requirements.join(", ") : "None";
  const {
    onOverrideChange,
    onAllNoneInfoChange,
    onNameChange,
      ...
      /* @__PURE__ */ jsx("div", { className: "flow-data-preview-body-section-row", children: /* @__PURE__ */ jsx(
        CheckboxInput,
        {
          label: /* @__PURE__ */ jsxs("div", { "data-testid": "import-flow-info-name-preview", children: [
            "Name: ",
            flowData == null ? void 0 : flowData.name
          ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "flow-data-preview-body-section-row", children: /* @__PURE__ */ jsx(
        CheckboxInput,
        {
          label: /* @__PURE__ */ jsxs("div", { "data-testid": "import-flow-info-description-preview", children: [
            "Description: ",
            flowData == null ? void 0 : flowData.description
          ] }),
...
const FlowModels = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flow-data-preview-body-section", children: [
    ...
    modelNodes == null ? void 0 : modelNodes.map((node) => {
    ...
    (modelNodes == null ? void 0 : modelNodes.length) === 0 && /* @__PURE__ */ jsx("div", { children: "No models in this flow" })
  ] });
};
const FlowTools = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flow-data-preview-body-section", children: [
    ...
    toolNodes && (toolNodes == null ? void 0 : toolNodes.length) > 1 && /* @__PURE__ */ jsx(
      CheckboxInput,
      {
    ...
    toolNodes == null ? void 0 : toolNodes.map((node) => {
      const toolNode = node;
      return /* @__PURE__ */ jsx("div", { className: "flow-data-preview-body-section-row", children: /* @__PURE__ */ jsx(
        CheckboxInput,
        {
    ...
    (toolNodes == null ? void 0 : toolNodes.length) === 0 && /* @__PURE__ */ jsx("div", { children: "No tools in this flow" })
  ] });
};
...
const EdgeLabel = ({ edge, transform }) => {
  ...
  const label = ((_a = edge.data) == null ? void 0 : _a.label) ?? "";
  if (label === "") {
    return null;
  }
...
const EdgePosition = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      className: "nodrag nopan",
      children: children || edgeNumber || ""
    }
  );
};
EdgePosition.displayName = "EdgePosition";
const useWaldiezEdge = (props) => {
  const {
    id,
    source,
    target,
  ...
  const sourceAgent = getAgentById(source);
  const targetAgent = getAgentById(target);
  ...
  const getEdgeColor = useCallback(() => {
    const agent = getAgentById(source);
    if (!agent) {
      return void 0;
    }
    const agentType = agent.data.agentType;
    if (ValidAgentTypes$2.includes(agentType)) {
  ...
  const getEdgeNumber = useCallback(() => {
    ...
    if (type === "nested") {
      const sourceLabel = sourceAgent.data.label;
      const sourceInitial = ((_a = sourceLabel == null ? void 0 : sourceLabel.charAt(0)) == null ? void 0 : _a.toUpperCase()) || "";
...
const getEdgeLabelTransformNodeOffset = (sourceX, sourceY, targetX, targetY, labelX, labelY, sourcePosition, targetPosition, labelType, options = {}) => {
  const {
    leftOffset = 60,
    // Distance for left-facing ports
    rightOffset = 60,
    // Distance for right-facing ports
    topOffset = 50,
    // Distance for top-facing ports
    bottomOffset = 50,
    // Distance for bottom-facing ports
    perpOffset = 20
    // Perpendicular offset from port direction
  } = options;
  if (labelType === "source") {
...
const getGroupChatIcon = (groupChatType, size) => {
  switch (groupChatType) {
    case "handoff":
      return /* @__PURE__ */ jsx(GiShakingHands, { size });
    case "nested":
      return /* @__PURE__ */ jsx(GiNestEggs, { size });
    default:
      return /* @__PURE__ */ jsx(MdMessage, { size });
  }
};
const getEdgeIcon = (type, groupChatType, edgeColor) => {
  ...
  switch (type) {
    case "chat":
      return /* @__PURE__ */ jsx(MdMessage, { color: edgeColor, size });
    case "nested":
      return /* @__PURE__ */ jsx(GiNestEggs, { color: edgeColor, size });
    default:
      return null;
  }
};
const WaldiezEdgeCommon = memo((props) => {
  const {
    id,
    type,
    data,
  ...
  const positionTranslation = useMemo(() => {
    const sourceTransform = getEdgeLabelTransformNodeOffset(
      ...
      {
        leftOffset: 10,
        // Labels on left-facing ports go 10px left
        rightOffset: 20,
        // Labels on right-facing ports go 20px right
        topOffset: 10,
        // Labels on top-facing ports go 0px up
        bottomOffset: 20,
        // Labels on bottom-facing ports go 20px down
        perpOffset: 20
        // All labels get 20px perpendicular offset
      }
    );
    const targetTransform = getEdgeLabelTransformNodeOffset(
      ...
      "target",
      {
        ...
        // Labels on left-facing ports go 10px left
        rightOffset: 10,
        // Labels on right-facing ports go 10px right
        topOffset: 10,
        // Labels on top-facing ports go 10px up
        bottomOffset: 10,
        // Labels on bottom-facing ports go 10px down
        perpOffset: -10
        // All labels get -10px perpendicular offset
      }
    );
    return {
  ...
  const onEdgeBlur = useCallback((event) => {
    event.target.blur();
    setFocussed(false);
  }, []);
          ...
          focussed && /* @__PURE__ */ jsxs("div", { className: "edge-actions", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx(FaTrash, { size: 12 })
              }
            ),
            /* @__PURE__ */ jsx(
              "div",
...
const useWaldiezEdgeModal = (props) => {
  var _a;
  ...
  const [edgeType, setEdgeType] = useState((edge == null ? void 0 : edge.type) ?? "chat");
  const [edgeData, setEdgeData] = useState(edge == null ? void 0 : edge.data);
  const [isDirty, setIsDirty] = useState(false);
  const isRagUserProxy = useMemo(
    () => {
      var _a2;
      return ((_a2 = sourceAgent == null ? void 0 : sourceAgent.data) == null ? void 0 : _a2.agentType) === "rag_user_proxy";
    },
    [(_a = sourceAgent == null ? void 0 : sourceAgent.data) == null ? void 0 : _a.agentType]
  );
  const onDataChange = useCallback(
    (data) => {
      ...
      setEdgeData(newData);
      setIsDirty(!isEqual(newData, edge == null ? void 0 : edge.data));
    },
    [edgeData, edge == null ? void 0 : edge.data]
  );
...
const useWaldiezEdgeBasicTab = (props) => {
  var _a, _b, _c, _d;
  ...
  const getEdgeSummaryLabel = useCallback(() => {
    var _a2;
    const args = ((_a2 = data.summary) == null ? void 0 : _a2.args) || {};
    if ("summary_role" in args && ["system", "user", "assistant"].includes(args.summary_role)) {
      const role = args.summary_role;
      return role[0].toUpperCase() + role.slice(1);
    }
    return "System";
  }, [(_a = data.summary) == null ? void 0 : _a.args]);
  const summaryMethodLabel = useMemo(
    () => {
      var _a2;
      return SUMMARY_METHOD_MAPPING[((_a2 = data.summary) == null ? void 0 : _a2.method) ?? "none"];
    },
    [(_b = data.summary) == null ? void 0 : _b.method]
  );
  const summaryRoleValue = useMemo(
    () => {
      var _a2, _b2;
      return ((_b2 = (_a2 = data.summary) == null ? void 0 : _a2.args) == null ? void 0 : _b2.summary_role) ?? "system";
    },
    [(_d = (_c = data.summary) == null ? void 0 : _c.args) == null ? void 0 : _d.summary_role]
  );
  const summaryRoleLabel = useMemo(() => getEdgeSummaryLabel(), [getEdgeSummaryLabel]);
  const currentSelectedChatType = useMemo(() => {
    var _a2;
    const chatTypeLabel = ((_a2 = EDGE_TYPE_OPTIONS.find((option) => option.value === edgeType)) == null ? void 0 : _a2.label) || "Chat";
    return {
      label: chatTypeLabel,
      value: edgeType
    };
...
const WaldiezEdgeBasicTab = (props) => {
...
const useWaldiezEdgeMessageTab = (props) => {
...
const WaldiezEdgeMessageTab = (props) => {
...
def callable_message(sender, recipient, context):
    ...
    ...
`;
const useWaldiezEdgeNestedTab = (props) => {
  const { data, onDataChange } = props;
...
const WaldiezEdgeNestedTab = (props) => {
  var _a, _b;
  const { flowId, edgeId, darkMode, data } = props;
  const { onNestedMessageTypeChange, onNestedMessageChange, onNestedReplyTypeChange, onNestedReplyChange } = useWaldiezEdgeNestedTab(props);
  const currentMessageInput = ((_a = data.nestedChat) == null ? void 0 : _a.message) ?? {
    type: "none",
    useCarryover: false,
    content: null,
    context: {}
  };
  const currentReplyInput = ((_b = data.nestedChat) == null ? void 0 : _b.reply) ?? {
    type: "none",
    useCarryover: false,
    content: null,
    context: {}
...
def nested_chat_reply(recipient, messages, sender, config):
    ...
    ...
`;
const WaldiezEdgeModal = memo((props) => {
  ...
  const groupChatType = useMemo(() => {
    ...
    return "handoff";
  }, [edgeType, edgeData == null ? void 0 : edgeData.targetType, edgeData == null ? void 0 : edgeData.sourceType, targetAgent == null ? void 0 : targetAgent.parentId]);
  ...
  const onNestedMessageTypeChange = useCallback(
    (type) => {
      ...
      const updatedMessage = {
        ...edgeData.nestedChat.message,
        content: ((_a = edgeData.nestedChat.message) == null ? void 0 : _a.content) || "",
        context: ((_b = edgeData.nestedChat.message) == null ? void 0 : _b.context) || {},
        type
      };
      onDataChange({
        nestedChat: {
...
const useAgentContentView = (id, data) => {
  const getModels2 = useWaldiez((s) => s.getModels);
  const getTools2 = useWaldiez((s) => s.getTools);
  ...
  const { tools, agentModelNames, agentWaldiezModelAPITypes, agentModelLogos } = useMemo(() => {
    const models = getModels2();
    const tools2 = getTools2();
    const agentModelNames2 = data.modelIds.map((modelId) => {
      var _a;
      return ((_a = models.find((model) => model.id === modelId)) == null ? void 0 : _a.data.label) ?? "";
    }).filter((entry) => entry !== "");
    const agentWaldiezModelAPITypes2 = data.modelIds.map((modelId) => {
      var _a;
      return ((_a = models.find((model) => model.id === modelId)) == null ? void 0 : _a.data.apiType) ?? "";
    }).filter((entry) => entry !== "");
    const agentModelLogos2 = agentWaldiezModelAPITypes2.map((apiType) => LOGOS[apiType] ?? "").filter((entry) => entry !== "");
    return {
      tools: tools2,
      agentModelNames: agentModelNames2,
      agentWaldiezModelAPITypes: agentWaldiezModelAPITypes2,
      agentModelLogos: agentModelLogos2
    };
  }, [getModels2, getTools2, data.modelIds]);
  const calculateDisplayCounts = useCallback(
    ...
    (availableHeight) => {
      ...
      let toolsToShow2 = 0;
      if (totalModels === 0) {
        toolsToShow2 = Math.min(totalTools, maxItems);
      } else if (totalTools === 0) {
        modelsToShow2 = Math.min(totalModels, maxItems);
      } else {
        modelsToShow2 = Math.min(totalModels, Math.ceil(maxItems / 2));
        toolsToShow2 = Math.min(totalTools, maxItems - modelsToShow2);
        if (modelsToShow2 < Math.ceil(maxItems / 2)) {
          const extra = Math.min(
            totalModels - modelsToShow2,
            maxItems - (modelsToShow2 + toolsToShow2)
          );
          modelsToShow2 += Math.max(0, extra);
        }
        if (toolsToShow2 < Math.floor(maxItems / 2)) {
          const extra = Math.min(totalTools - toolsToShow2, maxItems - (modelsToShow2 + toolsToShow2));
          toolsToShow2 += Math.max(0, extra);
        }
      }
      return { models: modelsToShow2, tools: toolsToShow2 };
    },
  ...
  const contentRef = useCallback(
    (node) => {
      ...
      const updateVisibleCounts = () => {
        ...
        const nodeHeight = (reactFlowNode == null ? void 0 : reactFlowNode.offsetHeight) || node.offsetHeight;
        const FOOTER_HEIGHT = 20;
        const PADDING = 20;
        const LABEL_HEIGHT = 40;
        const availableHeight = nodeHeight - FOOTER_HEIGHT - PADDING - LABEL_HEIGHT;
        setContainerHeight(availableHeight);
        const { models, tools: tools2 } = calculateDisplayCounts(availableHeight);
        setModelsToShow(models);
        setToolsToShow(tools2);
      };
  ...
  useEffect(() => {
    if (containerHeight === 0) {
      const { models, tools: tools2 } = calculateDisplayCounts(120);
      setModelsToShow(models);
      setToolsToShow(tools2);
    }
  ...
  return useMemo(() => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref: contentRef, className: "agent-content", children: [
      ...
      showModels && /* @__PURE__ */ jsxs("div", { className: "agent-models-preview", children: [
        agentModelNames.slice(0, modelsToShow).map((name, index) => /* @__PURE__ */ jsxs("div", { className: "agent-model-preview", "data-testid": "agent-model-preview", children: [
          /* @__PURE__ */ jsx("div", { className: `agent-model-img ${agentWaldiezModelAPITypes[index]}`, children: /* @__PURE__ */ jsx("img", { src: agentModelLogos[index], title: name, alt: name }) }),
          /* @__PURE__ */ jsx(
            "div",
            {
...
const useWaldiezNodeAgentModal = (id, isOpen, data, onClose) => {
  const flowId = useWaldiez((s) => s.flowId);
  const getAgentById = useWaldiez((s) => s.getAgentById);
  const updateAgentData = useWaldiez((s) => s.updateAgentData);
  const updateEdgeData = useWaldiez((s) => s.updateEdgeData);
  const exportAgent2 = useWaldiez((s) => s.exportAgent);
  const importAgent = useWaldiez((s) => s.importAgent);
  const getAgentConnections2 = useWaldiez((s) => s.getAgentConnections);
  ...
  const updateDescriptionTextArea = useCallback(
    (value) => {
      ...
      if (agentDescriptionElement) {
        agentDescriptionElement.value = value;
      }
    },
    [flowId, id]
  );
  ...
  const updateAgentEdgeLabels = useCallback(() => {
    const agentConnections = getAgentConnections2(id, {
      sourcesOnly: false,
      targetsOnly: false
    });
    ...
    sourceEdges.forEach((sourceEdge) => {
      ...
      const labelIndex = (_a = sourceEdge.data) == null ? void 0 : _a.label.indexOf(toSearch);
      if (typeof labelIndex === "number" && labelIndex > -1) {
        const label = (_b = sourceEdge.data) == null ? void 0 : _b.label.replace(toSearch, toReplace);
    ...
    targetEdges.forEach((targetEdge) => {
      ...
      const toSearch = `${oldLabel} => `;
      const toReplace = `${newLabel} => `;
      const labelIndex = (_a = targetEdge.data) == null ? void 0 : _a.label.indexOf(toSearch);
      if (typeof labelIndex === "number" && labelIndex > -1) {
        const label = (_b = targetEdge.data) == null ? void 0 : _b.label.replace(toSearch, toReplace);
        updateEdgeData(targetEdge.id, { ...targetEdge.data, label });
      }
    });
  }, [id, agentData.label, data.label, getAgentConnections2, updateEdgeData]);
  const updateAgentConnections = useCallback(
    ...
    [id, getAgentConnections2, updateEdgePath]
  );
  const handleAgentTypeChange = useCallback(
    (dataToSubmit) => {
      const newAgentType = dataToSubmit.agentType;
  ...
  const onImportLoad = useCallback(
    (agent, jsonData) => {
      const newAgent = importAgent(jsonData, id, true, agent == null ? void 0 : agent.position, false);
  ...
  const onExport = useCallback(async () => {
    await exportItem(agentData.label, "agent", exportAgent2.bind(null, id, true));
  }, [agentData.label, id, exportAgent2]);
  const onCancel = useCallback(() => {
    const storedAgent = getAgentById(id);
    if (!storedAgent) {
      setIsDirty(false);
...
const useGroupManagerTabs = (props) => {
  ...
  const models = useMemo(() => getModels2(), [getModels2]);
  const groupMembers = useMemo(() => getGroupMembers(id), [getGroupMembers, id]);
  const currentInitialAgent = useMemo(
    () => data.initialAgentId ? getAgentById(data.initialAgentId) : void 0,
  ...
  const onInitialAgentChange = useCallback(
    (option) => {
      if (!option) {
        onDataChange({ initialAgentId: void 0 });
        return;
      }
  ...
  const onSpeakerSelectionMethodChange = useCallback(
    (option) => {
      const selectionMethod = (option == null ? void 0 : option.value) ?? void 0;
...
const WaldiezAgentModels = memo((props) => {
...
const WaldiezNodeGroupManagerTabs = memo((props) => {
  var _a, _b, _c, _d;
  ...
  const speakerSelectionValue = useMemo(
    () => {
      var _a2, _b2;
      return {
        label: ((_a2 = speakerSelectionOptions.find((option) => {
          var _a3;
          return option.value === ((_a3 = data.speakers) == null ? void 0 : _a3.selectionMethod);
        })) == null ? void 0 : _a2.label) ?? "Auto",
        value: ((_b2 = data.speakers) == null ? void 0 : _b2.selectionMethod) ?? "auto"
      };
    },
    [(_a = data.speakers) == null ? void 0 : _a.selectionMethod, speakerSelectionOptions]
  );
  const showAfterwardsTab = !["manual", "auto"].includes((_b = data.speakers) == null ? void 0 : _b.selectionMethod);
  const getAgentName2 = (agentId) => {
    var _a2;
    return ((_a2 = groupMembers.find((agent) => agent.id === agentId)) == null ? void 0 : _a2.data.label) ?? agentId;
  };
    ...
    /* @__PURE__ */ jsx(TabItem, { label: "Speakers", id: `wf-${flowId}-agent-group-manager-speakers-${id}`, children: /* @__PURE__ */ jsxs("div", { className: "modal-body agent-panel", children: [
      ...
      /* @__PURE__ */ jsx(
        NumberInput,
        {
          ...
          value: ((_c = data.speakers) == null ? void 0 : _c.maxRetriesForSelecting) ?? 0,
      ...
      ((_d = data.speakers) == null ? void 0 : _d.selectionMethod) === "round_robin" && /* @__PURE__ */ jsxs("div", { className: "margin-top-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "ordered-items-list", children: speakersOrder.map((speaker, index) => {
...
const useWaldiezAgentBasic = (props) => {
...
const WaldiezAgentBasic = memo((props) => {
  const { id, data } = props;
  const {
    // onRagChange,
    onMultimodalChange,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "agent-panel agent-basic-panel", children: [
    data.agentType === "assistant" && /* @__PURE__ */ jsx(
      InfoCheckbox,
      {
        ...
        checked: data.isMultimodal ?? false,
...
const useWaldiezAgentCaptain = (props) => {
  const { data, onDataChange } = props;
  const [enableAgentLib, setEnableAgentLib] = useState(data.agentLib.length > 0);
  const [agentLib, setAgentLib] = useState(data.agentLib);
  useEffect(() => {
  ...
  const parseAgentLibList = useCallback((result) => {
    const parsedAgentLib = [];
      ...
      for (const entry of result) {
        if (typeof entry === "object" && entry !== null) {
          ...
          if (typeof name === "string" && typeof description === "string") {
            ...
            const systemMessage = typeof entryObject.systemMessage === "string" ? entryObject.systemMessage : typeof entryObject.system_message === "string" ? entryObject.system_message : null;
            if (systemMessage) {
              parsedAgentLib.push({
                name,
                description,
...
const WaldiezAgentCaptainTab = memo((props) => {
...
const useWaldiezAgentCodeExecution = (props) => {
  const { data, onDataChange, tools } = props;
  const getToolName = useCallback(
    (toolId) => {
      const tool = tools.find((tool2) => tool2.id === toolId);
      return (tool == null ? void 0 : tool.data.label) ?? "Unknown Tool";
    },
    [tools]
  );
  ...
  const codeExecutionValue = useMemo(() => {
    ...
    return (((_a = data.codeExecutionConfig) == null ? void 0 : _a.functions) ?? []).map((func) => ({
  ...
  const onCodeExecutionWorkDirChange = useCallback(
    (event) => {
      ...
      onDataChange({
        codeExecutionConfig: typeof data.codeExecutionConfig === "object" ? { ...data.codeExecutionConfig, workDir } : { workDir }
      });
    },
    [data.codeExecutionConfig, onDataChange]
  );
  const onCodeExecutionLastNMessagesChange = useCallback(
    (value) => {
      ...
      onDataChange({
        codeExecutionConfig: typeof data.codeExecutionConfig === "object" ? { ...data.codeExecutionConfig, lastNMessages } : { lastNMessages }
      });
    },
    [data.codeExecutionConfig, onDataChange]
  );
  const onCodeExecutionTimeoutChange = useCallback(
    (value) => {
      ...
      onDataChange({
        codeExecutionConfig: typeof data.codeExecutionConfig === "object" ? { ...data.codeExecutionConfig, timeout } : { timeout }
      });
    },
    [data.codeExecutionConfig, onDataChange]
  );
  const onCodeExecutionUseDockerChange = useCallback(
    (checked) => {
      onDataChange({
        codeExecutionConfig: typeof data.codeExecutionConfig === "object" ? { ...data.codeExecutionConfig, useDocker: checked } : { useDocker: checked }
      });
    },
    [data.codeExecutionConfig, onDataChange]
  );
  const onExecutionFunctionsChange = useCallback(
    (newValue) => {
      ...
      const selectedFunctionIds = selectedFunctions.map((f) => f == null ? void 0 : f.value).filter(Boolean);
      onDataChange({
        codeExecutionConfig: typeof data.codeExecutionConfig === "object" ? { ...data.codeExecutionConfig, functions: selectedFunctionIds } : { functions: selectedFunctionIds }
      });
    },
    [data.codeExecutionConfig, onDataChange]
  );
...
const WaldiezAgentCodeExecution = memo((props) => {
  ...
  const lastNMessagesValue = isCodeExecutionEnabled && data.codeExecutionConfig !== false && ((_a = data.codeExecutionConfig) == null ? void 0 : _a.lastNMessages) && ((_b = data.codeExecutionConfig) == null ? void 0 : _b.lastNMessages) !== "auto" ? (_c = data.codeExecutionConfig) == null ? void 0 : _c.lastNMessages : 0;
  const isDockerEnabled = isCodeExecutionEnabled && data.codeExecutionConfig !== false && ((_d = data.codeExecutionConfig) == null ? void 0 : _d.useDocker) === true;
    ...
    isCodeExecutionEnabled && data.codeExecutionConfig !== false && /* @__PURE__ */ jsxs("div", { className: "agent-node-codeExecution-options margin-top-10", children: [
      /* @__PURE__ */ jsx(
        TextInput,
        {
          ...
          value: ((_e = data.codeExecutionConfig) == null ? void 0 : _e.workDir) ?? "",
      ...
      /* @__PURE__ */ jsx(
        NumberInput,
        {
          label: "Timeout:",
          name: "timeout",
          value: ((_f = data.codeExecutionConfig) == null ? void 0 : _f.timeout) ?? 0,
...
const useWaldiezAgentGroupMember = (props) => {
  ...
  const currentGroupManager = useMemo(
    () => data.parentId ? groupManagers.find((agent) => agent.id === data.parentId) : void 0,
  ...
  const [selectedGroup, setSelectedGroup] = useState(currentGroupManager);
  useEffect(() => {
    setSelectedGroup(currentGroupManager);
  }, [currentGroupManager]);
  const onSelectGroupChange = useCallback(
    (option) => {
      setSelectedGroup(option ? option.value : void 0);
    },
    []
  );
  const onJoinGroup = useCallback(() => {
    onDataChange({ parentId: selectedGroup == null ? void 0 : selectedGroup.id });
  }, [selectedGroup, onDataChange]);
  const onLeaveGroup = useCallback(() => {
    onDataChange({ parentId: void 0 });
  }, [onDataChange]);
  const onAfterWorkChange = useCallback(
    (target) => {
...
const WaldiezAgentGroupNestedChatTabs = memo((props) => {
  ...
  useEffect(() => {
    var _a;
    if (!((_a = data == null ? void 0 : data.nestedChats) == null ? void 0 : _a.length)) {
      return;
    }
  ...
  const getRecipientName = useCallback(
    (edgeId) => {
      const edge = agentConnections.targets.edges.find((edge2) => edge2.id === edgeId);
      if (!edge) {
        return "";
      }
  ...
  return /* @__PURE__ */ jsx("div", { className: "agent-panel", "data-testid": `agent-group-nested-chat-tabs-${id}`, children: /* @__PURE__ */ jsxs(TabItems, { activeTabIndex: 0, children: [
    /* @__PURE__ */ jsx(TabItem, { label: "Queue", id: `wf-${flowId}-wa-${id}-nested-chats-queue`, children: /* @__PURE__ */ jsx("div", { className: "flex-column margin-10 nested-chat-queue", children: nestedChats[0].messages.map((message, index) => /* @__PURE__ */ jsxs(
      ...
      `agent-${id}-nestedChat-recipient-${index}`
    )) }) }),
...
const useWaldiezAgentNestedChats = (props) => {
  ...
  const triggerSelectOptions = useMemo(
    () => allNodes.map((node) => {
      var _a;
      return {
        label: (_a = node.data) == null ? void 0 : _a.label,
        value: node.id
      };
    }),
    [allNodes]
  ...
  const messageSelectOptions = useMemo(
    () => allEdges.map((edge) => {
      var _a;
      return {
        label: (_a = edge.data) == null ? void 0 : _a.label,
        value: edge.id
      };
    }),
    [allEdges]
  ...
  const getEdgeLabel = useCallback(
    (id) => {
      ...
      return ((_a = edge == null ? void 0 : edge.data) == null ? void 0 : _a.label) || "Unknown";
    },
    [allEdges]
  );
  ...
  const onAddNestedChatConnection = useCallback(() => {
    ...
    const isDuplicate = chat.messages.some(
      (recipient) => recipient.id === selectedRecipient.id && recipient.isReply === selectedRecipient.isReply
    );
    if (isDuplicate) {
      return;
    }
    ...
    (option) => {
      if (option && option.value) {
        setSelectedRecipient((prevState) => ({
          id: option.value,
          isReply: (prevState == null ? void 0 : prevState.isReply) || false
        }));
      } else {
...
const WaldiezAgentNestedChatsMessages = memo((props) => {
  const {
    id,
    chat,
    selectOptions,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "nested-chat-messages", "data-testid": `nested-chat-messages-${id}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "nested-chats-add-message", children: [
      ...
      /* @__PURE__ */ jsx(
        CheckboxInput,
        {
          ...
          label: "Agent's reply",
          isChecked: (selectedRecipient == null ? void 0 : selectedRecipient.isReply) ?? false,
    ...
    /* @__PURE__ */ jsx("div", { className: "nested-chats-registered-messages", children: hasNoMessages ? /* @__PURE__ */ jsx("div", { className: "nested-chat-registered-message", children: "No messages to include" }) : /* @__PURE__ */ jsx("div", { className: "flex-1 messages-list", children: chat.messages.map((target, index) => /* @__PURE__ */ jsx(
      MessageListItem,
      {
        target,
        index,
...
const WaldiezAgentNestedChatsTriggers = memo((props) => {
  const { id, selectOptions, selectedTriggers, onSelectedTriggersChange } = props;
  const currentTriggers = useMemo(
    () => selectedTriggers.map((trigger) => {
      const option = selectOptions.find((option2) => option2.value === trigger);
      return {
        label: (option == null ? void 0 : option.label) || "Unknown",
        value: trigger
      };
    }),
...
const WaldiezAgentNestedChats = memo((props) => {
  const { id } = props;
  const {
    chat,
    triggerSelectOptions,
...
const useWaldiezAgentRagUserVectorDb = (props) => {
  const { data, onDataChange } = props;
...
const useWaldiezAgentRagUserRetrieveConfig = (props) => {
...
const WaldiezAgentRagUserRetrieveConfig = memo((props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rag-retrieve-config-container", "data-testid": `rag-retrieve-config-${id}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        ...
        {
          label: "Task:",
          info: 'The task of the retrieve chat. Possible values are "code", "qa" and "default". The system prompt will be different for different tasks. The default value is `default`, which supports both code and qa, and provides source information in the end of the response.',
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      ...
      /* @__PURE__ */ jsx(
        StringList,
        {
          ...
          viewLabelInfo: "The paths of the documents for the retrieve chat. It can be a list of directories, files and urls. Default is None, which works only if the collection is already created.",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        InfoLabel,
        {
          ...
          info: "The number of results to return. Default is None, which means the system will return all the results. Will be ignored if < 1.",
...
const useWaldiezAgentRagUserTextSplit = (props) => {
  const { data, onDataChange } = props;
  const setRetrieveConfigConfigData = useCallback(
    (partialData) => {
      onDataChange({
...
const WaldiezAgentRagUserTextSplit = memo((props) => {
  const { id, data } = props;
  const { retrieveConfig } = data;
  const {
    onChunkTokenSizeChange,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "text-split-config", "data-testid": `rag-text-split-config-${id}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        InfoLabel,
        {
          ...
          info: "The chunk token size for the retrieve chat. If not provided, a default size `max_tokens * 0.4` will be used.",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        InfoLabel,
        {
          ...
          info: "The context max token size for the retrieve chat. If not provided, a default size `max_tokens * 0.8` will be used.",
    ...
    showEmptyLineBreak && /* @__PURE__ */ jsx("div", { className: "flex-column", children: /* @__PURE__ */ jsx(
      InfoCheckbox,
      {
        ...
        info: 'Chunk will only break at empty line if True. Default is True. If chunk_mode is "one_line", this parameter will be ignored.',
...
const useWaldiezAgentRagUserAdvanced = (props) => {
  const { data, onDataChange } = props;
  const setRetrieveConfigConfigData = useCallback(
    (partialData) => {
      onDataChange({
...
const WaldiezAgentRagUserAdvanced = memo((props) => {
  const { id, data } = props;
  const { retrieveConfig } = data;
  const {
    onCustomizedPromptChange,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rag-advanced-settings", "data-testid": `rag-advanced-settings-${id}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        InfoLabel,
        {
          ...
          info: 'The customized answer prefix for the retrieve chat. Default is "".If not "" and the customized_answer_prefix is not in the answer, `Update Context` will be triggered.',
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-column", children: /* @__PURE__ */ jsx(
      ...
      {
        label: "New Docs ",
        info: "When True, only adds new documents to the collection; when False, updates existing documents and adds new ones. The default value is True. Document id is used to determine if a document is new or existing. By default, the id is the hash value of the content.",
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-column", children: /* @__PURE__ */ jsx(
      ...
      {
        label: "Overwrite ",
        info: "Whether to overwrite the collection if it exists. Default is False. Case 1. if the collection does not exist, create the collection. Case 2. the collection exists, if overwrite is True, it will overwrite the collection. Case 3. the collection exists and overwrite is False, if get_or_create is True, it will get the collection, otherwise it raise a ValueError.",
...
const useWaldiezAgentRagUserCustomFunctions = (props) => {
  const { data, onDataChange } = props;
  const setRetrieveConfigConfigData = useCallback(
    (partialData) => {
      onDataChange({
...
const DEFAULT_RAG_CUSTOM_EMBEDDING_FUNCTION = `"""Custom embedding function."""
...
def custom_embedding_function():
    ...
    ...
`;
const DEFAULT_RAG_CUSTOM_TOKEN_COUNT_FUNCTION = `"""Custom function to count the number of tokens in a string.
...
def custom_token_count_function(text, model):
    ...
    ...
`;
const DEFAULT_RAG_CUSTOM_TEXT_SPLIT_FUNCTION = `"""Custom text split function.
...
def custom_text_split_function(
    ...
    ...
`;
const WaldiezAgentRagUserCustomFunctions = memo((props) => {
...
const useWaldiezAgentReasoning = (props) => {
  const { data, onDataChange } = props;
  ...
  const reasoningMethodValue = useMemo(
    () => {
      ...
      return {
        ...
        label: ((_a = reasoningMethodOptions.find((option) => option.value === data.reasonConfig.method)) == null ? void 0 : _a.label) || "Beam Search"
      };
    },
  ...
  const answerApproachValue = useMemo(
    () => {
      ...
      return {
        ...
        label: ((_a = answerApproachOptions.find((option) => option.value === data.reasonConfig.answerApproach)) == null ? void 0 : _a.label) || "Pool"
      };
    },
...
const WaldiezAgentReasoning2 = memo((props) => {
  const { id, data } = props;
  const {
    reasoningMethodOptions,
    reasoningMethodValue,
...
WaldiezAgentReasoning2.displayName = "WaldiezAgentReasoning";
...
const terminationCriterionOptions = [
  ...
  { label: "Keyword is the last word", value: "ending" },
...
const useWaldiezAgentTermination = (props) => {
  const { data, onDataChange } = props;
  const { isDark } = useWaldiezTheme();
  const defaultTerminationMethodContent = useMemo(
    () => data.termination.methodContent && data.termination.methodContent.length > 1 ? data.termination.methodContent : DEFAULT_IS_TERMINATION_MESSAGE_METHOD_CONTENT,
  ...
  const onTerminationKeywordChange = useCallback(
    (oldKeyword, newKeyword) => {
      onDataChange({
        termination: {
          ...data.termination,
          keywords: data.termination.keywords.map(
            (keyword) => keyword === oldKeyword ? newKeyword : keyword
          )
        }
      });
    },
...
const WaldiezAgentTermination = memo((props) => {
  var _a;
  const { id } = props;
  const {
    data,
    isDarkMode,
    terminationCriterionOptions: terminationCriterionOptions2,
    terminationTypeOptions: terminationTypeOptions2,
    defaultTerminationMethodContent,
    onTerminationTypeChange,
    onTerminationMethodChange,
    onTerminationCriterionChange,
  ...
  const terminationTypeValue = useMemo(
    () => {
      var _a2, _b;
      return {
        label: ((_a2 = terminationTypeOptions2.find((option) => option.value === data.termination.type)) == null ? void 0 : _a2.label) ?? "None",
        value: ((_b = data.termination) == null ? void 0 : _b.type) ?? "none"
      };
    },
    [data.termination.type, terminationTypeOptions2]
  );
  const terminationCriterionValue = useMemo(() => {
    const entry = terminationCriterionOptions2.find((option) => option.value === data.termination.criterion);
    if (!entry) {
      return void 0;
    }
    return {
    ...
    showKeywordSettings && /* @__PURE__ */ jsxs("div", { className: "margin-top-10", children: [
      ...
      /* @__PURE__ */ jsx(
        StringList,
        {
          ...
          items: ((_a = data.termination) == null ? void 0 : _a.keywords) ?? [],
...
const WaldiezNodeAgentModalTabs = memo(
  ({
    id,
    data,
    flowId,
    ...
    const getModels2 = useWaldiez((s) => s.getModels);
    const getTools2 = useWaldiez((s) => s.getTools);
    const getEdges2 = useWaldiez((s) => s.getEdges);
    const uploadHandler = useWaldiez((s) => s.onUpload);
    const [activeTabIndex, setActiveTabIndex] = useState(0);
    useEffect(() => {
      setActiveTabIndex(0);
    ...
    const derivedData = useMemo(() => {
      ...
      const agents2 = getAgents2();
      const tools2 = getTools2();
      const edges2 = getEdges2();
      const groupManagers2 = agents2.filter((agent) => agent.data.agentType === "group_manager");
      const connectionsCount = agentConnections2.targets.edges.length + agentConnections2.sources.edges.length;
      const showNestedChatsTab2 = !isGroupMember && connectionsCount > 0;
      let showGroupNestedChatTab2 = false;
      let groupMembers = [];
      let connectionsOutsideGroup2 = [];
      if (isGroupMember) {
        groupMembers = agents2.filter((agent) => agent.data.parentId === data.parentId);
        connectionsOutsideGroup2 = agentConnections2.targets.edges.filter(
          (edge) => groupMembers.findIndex((member) => member.id === edge.target) === -1
        );
        showGroupNestedChatTab2 = connectionsOutsideGroup2.length > 0;
      }
      const uploadsEnabled2 = !!uploadHandler;
      return {
        agentConnections: agentConnections2,
        models: models2,
        agents: agents2,
        edges: edges2,
        tools: tools2,
        groupManagers: groupManagers2,
        showNestedChatsTab: showNestedChatsTab2,
        showGroupNestedChatTab: showGroupNestedChatTab2,
        groupMembers,
        connectionsOutsideGroup: connectionsOutsideGroup2,
        uploadsEnabled: uploadsEnabled2
      };
    }, [
      getAgentConnections2,
      getModels2,
      getAgents2,
      getEdges2,
      getTools2,
...
const WaldiezNodeAgentModal = memo((props) => {
  ...
  const importExportView = useMemo(
    () => data.agentType !== "group_manager" ? getImportExportView(flowId, id, "agent", onImport, onExport) : void 0,
    [data.agentType, flowId, id, onImport, onExport]
  );
  const modalTitle = useMemo(
    () => data.agentType === "group_manager" ? agentData.groupName : agentData.label,
...
const WaldiezNodeAgentView = (props) => {
...
function TbSettingsCheck(props) {
...
`).join("");
   ...
   */
  buildSignedHeadersList(headers) {
...
const validateModelBaseUrl = (model) => {
...
const validateModelInputs = (model) => {
  ...
  if (model.apiType === "azure" && !model.apiVersion) {
    return {
      success: false,
      message: "Missing Azure API version"
      /* MissingApiVersion */
    };
  }
  return { success: true, message, details };
};
const buildRequestConfig = (model, baseUrl) => {
...
const validateAzureModel = async (url, headers, modelName) => {
  try {
    ...
    const found = Array.isArray(data.data) && data.data.some((d) => d.id === modelName);
    return found ? {
      success: true,
      message: "Model validated successfully"
      /* ValidationSuccess */
...
const validateBedrockModel = async (additionalHeaders, modelName, aws) => {
...
const validateDirectModel = async (url, headers, modelName) => {
  try {
...
const validateFallbackModel = async (url, headers, modelName) => {
  try {
    const res = await fetchWithTimeout(url, { method: "GET", headers });
    if (!res.ok) {
      return parseErrorResponse(res);
...
const parseErrorResponse = async (res) => {
  ...
  try {
    ...
    const errorDetails = ((_a = errorBody == null ? void 0 : errorBody.error) == null ? void 0 : _a.message) || res.statusText || "Unknown error";
...
const handleFetchError = (error) => {
  ...
  const errorMessage = isAbortError ? "Could not get a response from the model's endpoint" : "Unknown error";
  const details = error instanceof Error ? error.message : String(error);
  return {
    success: false,
...
const parseBedrockResponse = async (response, modelName, region) => {
  if (response.ok) {
    return {
      success: true,
      message: "Model validated successfully",
...
const useWaldiezNodeModel = (id, data) => {
  ...
  const exportModel2 = useWaldiez((s) => s.exportModel);
  const onFlowChanged = useWaldiez((s) => s.onFlowChanged);
  const flowId = useWaldiez((state) => state.flowId);
  const [logo, setLogo] = useState(LOGOS[data.apiType] || "");
  ...
  const onImportLoad = useCallback(
    (model, jsonData) => {
      const nodeModel = importModel(jsonData, id, model == null ? void 0 : model.position, false);
  ...
  const onImport = useCallback(
    (event) => {
      const getModelByIdBound = (modelId) => getModelById(modelId);
      importItem(event, getModelByIdBound.bind(null, id), onImportLoad);
    },
    [getModelById, id, onImportLoad]
  );
  const onExport = useCallback(async () => {
    await exportItem(data.label, "model", () => exportModel2(id, true));
  }, [data.label, exportModel2, id]);
  const onDataChange = useCallback(
    (partialData) => {
  ...
  const onCheck = useCallback(() => {
    validateModel(modelData).then((result) => {
      if (result.success) {
        showSnackbar({
          flowId,
  ...
  const onSave = useCallback(() => {
    ...
    if (storedModel == null ? void 0 : storedModel.data) {
...
const useModelModalAdvancedTab = (props) => {
  const { data, onDataChange } = props;
...
const WaldiezNodeModelModalAdvancedTab = memo(
  (props) => {
    const { data } = props;
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
      /* @__PURE__ */ jsx(
        NumberInput,
        {
          name: "temperature",
          label: "Temperature:",
          value: temperature !== null ? temperature : -1e-3,
      ...
      /* @__PURE__ */ jsx(
        NumberInput,
        {
          name: "top-p",
          label: "Top P:",
          labelInfo: "Top P value for sampling (it is recommended to use either temperature or top P, not both)",
          value: topP !== null ? topP : -1e-3,
...
const WaldiezNodeModelModalAWSTab = memo(({ data, onDataChange }) => {
  var _a, _b, _c, _d, _e;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-column", children: [
    /* @__PURE__ */ jsx(
      TextInput,
      {
        value: ((_a = data.aws) == null ? void 0 : _a.accessKey) || "",
        name: "aws-access-key",
    ...
    /* @__PURE__ */ jsx(
      TextInput,
      {
        value: ((_b = data.aws) == null ? void 0 : _b.secretKey) || "",
        name: "aws-secret-key",
    ...
    /* @__PURE__ */ jsx(
      TextInput,
      {
        value: ((_c = data.aws) == null ? void 0 : _c.region) || "",
        name: "aws-region",
        label: "AWS Region:",
    ...
    /* @__PURE__ */ jsx(
      TextInput,
      {
        value: ((_d = data.aws) == null ? void 0 : _d.profileName) || "",
    ...
    /* @__PURE__ */ jsx(
      TextInput,
      {
        value: ((_e = data.aws) == null ? void 0 : _e.sessionToken) || "",
...
const useModelModalBasicTab = (props) => {
  const { data, onDataChange, onLogoChange } = props;
  const { apiType } = data;
  const predefinedModelsSelectRef = useRef(null);
  const [apiKeyVisible, setApiKeyVisible] = useState(false);
  const getBaseUrl2 = useCallback((type) => {
    return baseUrlsMapping[type];
  }, []);
  const isBaseUrlEditable = useCallback((type) => {
  ...
  const onApiTypeChange = useCallback(
    (option) => {
      ...
      (_a = predefinedModelsSelectRef.current) == null ? void 0 : _a.clearValue();
  ...
  const readOnlyBaseUrl = useMemo(() => getBaseUrl2(apiType), [getBaseUrl2, apiType]);
...
const WaldiezNodeModelModalBasicTab = memo(
  (props) => {
    const { id, data } = props;
    ...
    const {
      ...
      urlIsEditable,
      apiKeyVisible,
      apiTypeOptions: apiTypeOptions2,
      readOnlyBaseUrl,
      predefinedModelsSelectRef,
      onDataChange,
      onApiKeyVisibleChange,
    ...
    const onPredefineSelected = useMemo(
      () => (selected) => {
        ...
        const { label: label2, apiType: apiType2 } = selected;
        onDataChange({ label: label2, apiType: apiType2 });
      },
      [onDataChange]
    );
...
const useModelModalPriceTab = (props) => {
  var _a, _b;
  const { data, onDataChange } = props;
  const onPricePromptChange = useCallback(
    (e) => {
      ...
      const completionTokenPricePer1k = ((_a2 = data.price) == null ? void 0 : _a2.completionTokenPricePer1k) ?? null;
      onDataChange({
        price: {
    ...
    [(_a = data.price) == null ? void 0 : _a.completionTokenPricePer1k, onDataChange]
  );
  const onPriceCompletionChange = useCallback(
    (e) => {
      ...
      const promptPricePer1k = ((_a2 = data.price) == null ? void 0 : _a2.promptPricePer1k) ?? null;
      onDataChange({
        price: {
    ...
    [(_b = data.price) == null ? void 0 : _b.promptPricePer1k, onDataChange]
  );
  return {
    onPricePromptChange,
...
const WaldiezNodeModelModalPriceTab = memo(
  (props) => {
    var _a, _b;
    ...
    const promptPriceValue = useMemo(
      () => {
        var _a2;
        return ((_a2 = data.price) == null ? void 0 : _a2.promptPricePer1k) !== null ? data.price.promptPricePer1k : -1;
      },
      [(_a = data.price) == null ? void 0 : _a.promptPricePer1k]
    );
    const completionPriceValue = useMemo(
      () => {
        var _a2;
        return ((_a2 = data.price) == null ? void 0 : _a2.completionTokenPricePer1k) !== null ? data.price.completionTokenPricePer1k : -1;
      },
      [(_b = data.price) == null ? void 0 : _b.completionTokenPricePer1k]
    );
...
const WaldiezNodeModelView = ({ id, data }) => {
  const {
    flowId,
    isOpen,
    isDirty,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            onClick: onClone,
            children: /* @__PURE__ */ jsx(FaCopy$1, {})
          }
        )
      ] })
    ] }),
...
const useWaldiezNodeTool = (id, data) => {
  const flowId = useWaldiez((state) => state.flowId);
  ...
  const exportTool2 = useWaldiez((s) => s.exportTool);
  const onFlowChanged = useWaldiez((s) => s.onFlowChanged);
  const { isDark } = useWaldiezTheme();
  ...
  const onExport = useCallback(async () => {
    await exportItem(data.label, "tool", () => exportTool2(id, true));
  }, [data.label, exportTool2, id]);
  const onImportLoad = useCallback(
    (tool, jsonData) => {
      const newTool = importTool(jsonData, id, tool == null ? void 0 : tool.position, false);
  ...
  const onImport = useCallback(
    (event) => {
      const getToolByIdBound = (toolId) => getToolById(toolId);
  ...
  const onSave = useCallback(() => {
    ...
    if (storedTool == null ? void 0 : storedTool.data) {
      setToolData(storedTool.data);
    }
    setIsDirty(false);
    onFlowChanged();
...
const WaldiezNodeToolView = (props) => {
  const { id } = props;
  const {
    flowId,
    isModalOpen,
...
const useSidebarView = (props) => {
  ...
  const [isAgentsViewCollapsed, setIsAgentsViewCollapsed] = useState(false);
  const flowId = useWaldiez((s) => s.flowId);
  const onDragStart = useCallback(
    (event, nodeType, agentType) => {
...
const useEditFlowModal = (props) => {
  ...
  const [selectedNewEdge, setSelectedNewEdge] = useState(null);
  const getFlowEdges = useWaldiez((s) => s.getFlowEdges);
  const { used: sortedEdges, remaining: remainingEdges } = getFlowEdges();
  const onFlowChanged = useWaldiez((s) => s.onFlowChanged);
  const [sortedEdgesState, setSortedEdgesState] = useState(sortedEdges);
  const [remainingEdgesState, setRemainingEdgeState] = useState(remainingEdges);
  ...
  const [isDirty, setIsDirty] = useState(isDataDirty || isEdgesDirty);
  const onSubmit = () => {
    updateFlowInfo(flowData);
    if (!flowData.isAsync) {
      const edgeOrders = sortedEdgesState.map((edge, index) => ({
        id: edge.id,
        order: index
      })).concat(
  ...
  const reset = useCallback(() => {
    const { name: name2, description: description2, requirements: requirements2, tags: tags2, isAsync: isAsync2, cacheSeed: cacheSeed2 } = getFlowInfo();
    setFlowData({
      name: name2,
      description: description2,
      requirements: requirements2,
  ...
  const onDataChange = (partialData) => {
    const isDataDirty2 = !isEqual(
      { ...flowData, ...partialData },
      { name, description, requirements, tags, isAsync, cacheSeed }
    );
    const isEdgesDirty2 = !isEqual(sortedEdgesState, sortedEdges);
    setFlowData({ ...flowData, ...partialData });
    setIsDirty(isDataDirty2 || isEdgesDirty2);
  };
  const onSelectedNewEdgeChange = (option) => {
    if (option) {
  ...
  const getNewEdgeOrder = () => {
    var _a, _b;
    let lastOrder = (_b = (_a = sortedEdgesState[sortedEdgesState.length - 1]) == null ? void 0 : _a.data) == null ? void 0 : _b.order;
    if (lastOrder === void 0) {
  ...
  const onAddEdge = () => {
    ...
    if (remainingEdgesState.find((e) => e.id === selectedNewEdge.id)) {
      ...
      const newSelectedEdge = {
        ...selectedNewEdge,
        data: { ...selectedNewEdge.data, order: lastOrder }
      };
  ...
  const setSyncPrerequisites = (newSortedEdges) => {
  ...
  const onPrerequisitesChange = (edge, prerequisites) => {
  ...
  const onMoveEdgeDown = (index) => {
    ...
    if (sortedEdgesState.find((e) => e.id === sortedEdgesState[index].id)) {
      ...
      const nextOrder = (_a = nextEdge.data) == null ? void 0 : _a.order;
      const currentEdge = sortedEdgesState[index];
      const currentOrder = (_b = currentEdge.data) == null ? void 0 : _b.order;
      const newSortedEdges = sortedEdgesState.slice();
...
const HandleASyncChatOrderAndPrerequisites = (props) => {
  var _a;
  const {
    sortedEdges,
    remainingEdges,
  ...
  const onSetChatPrerequisitesChange = (edge, options) => {
    if (options) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flow-chat-prerequisites-wrapper", children: [
    ...
    sortedEdges.map((edge, index) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "flow-chat-prerequisites", children: [
        /* @__PURE__ */ jsx("div", { className: "flow-chat-prerequisite-source", children: /* @__PURE__ */ jsx("span", { children: (_a2 = edge.data) == null ? void 0 : _a2.label }) }),
        sortedEdges.length > 1 && /* @__PURE__ */ jsxs("div", { className: "flow-chat-prerequisite-actions", children: [
          ...
          /* @__PURE__ */ jsx(
            Select,
            {
              ...
              options: sortedEdges.filter((e) => e.id !== edge.id).map((edge2) => {
                var _a3;
                return {
                  value: edge2,
                  label: (_a3 = edge2.data) == null ? void 0 : _a3.label
                };
              }),
              value: (_b = edge.data) == null ? void 0 : _b.prerequisites.map((prerequisite) => {
                var _a3;
                const edge2 = sortedEdges.find((e) => e.id === prerequisite);
                return edge2 ? {
                  value: edge2,
                  label: (_a3 = edge2.data) == null ? void 0 : _a3.label
                } : [];
        ...
        /* @__PURE__ */ jsx(
          Select,
          {
            options: remainingEdges.map((edge) => {
              ...
              return {
                value: edge,
                label: (_a2 = edge.data) == null ? void 0 : _a2.label
              };
            }),
            value: selectedNewEdge ? {
              value: selectedNewEdge,
              label: (_a = selectedNewEdge.data) == null ? void 0 : _a.label
            } : null,
...
const HandleSyncChatOrder = (props) => {
  var _a;
  const {
    sortedEdges,
    remainingEdges,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flow-chat-order-wrapper", children: [
    ...
    sortedEdges.map((edge, index) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "flow-order-item-wrapper", children: [
        /* @__PURE__ */ jsx("div", { className: "flow-order-item", children: /* @__PURE__ */ jsx("span", { className: "flow-order-item-entry", children: (_a2 = edge.data) == null ? void 0 : _a2.label }) }),
        sortedEdges.length > 1 && /* @__PURE__ */ jsxs("div", { className: "flow-order-item-actions", children: [
          index > 0 && sortedEdges.length > 1 && /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              title: "Move up",
          ...
          index < sortedEdges.length - 1 && /* @__PURE__ */ jsx(
            "button",
            {
              title: "Move down",
              type: "button",
...
const EditFlowModalModalTabBasic = (props) => {
  ...
  const onNameChange = (event) => {
    ...
    onDataChange({ name: name2 });
  };
  const onDescriptionChange = (event) => {
    const description2 = event.target.value;
    onDataChange({ description: description2 });
  };
  const onAsyncChange = (checked) => {
...
const EditFlowModalModalTabOther = (props) => {
  ...
  const onTagChange = (oldValue, newValue) => {
    onDataChange({
      tags: tags.map((t) => t === oldValue ? newValue : t)
    });
  };
  const onAddRequirement = (requirement) => {
  ...
  const onCacheSeedValueChange = (e) => {
    try {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        typeof cacheSeed === "number" && /* @__PURE__ */ jsxs("div", { className: "cache-seed-view flex", children: [
...
const WaldiezFlowView = memo((props) => {
  ...
  const setSelectedNodeType = useCallback((nodeType) => {
  ...
  const onViewportChange = useCallback(
    (viewport2) => {
      handleViewportChange(viewport2, selectedNodeType.current);
    },
        ...
        /* @__PURE__ */ jsxs("div", { className: "flow-main", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "react-flow-wrapper", "data-testid": `rf-wrapper-${flowId}`, ref: rfParent, children: /* @__PURE__ */ jsxs(
            ReactFlow,
            {
              ...
              width: (_a = rfParent.current) == null ? void 0 : _a.clientWidth,
              height: (_b = rfParent.current) == null ? void 0 : _b.clientHeight,
              onNodeDrag,
              onNodeDragStop,
              children: [
...
const Waldiez = (props) => {
  const flowId = props.flowId ?? `wf-${getId()}`;
  ...
  return /* @__PURE__ */ jsx(SnackbarProvider, { children: /* @__PURE__ */ jsx(WaldiezThemeProvider, { children: /* @__PURE__ */ jsx(ErrorBoundary, { fallbackRender, children: /* @__PURE__ */ jsx(HotkeysProvider, { initiallyActiveScopes: [flowId], children: /* @__PURE__ */ jsx(ReactFlowProvider, { children: /* @__PURE__ */ jsx(SidebarProvider, { children: /* @__PURE__ */ jsx(
    WaldiezProvider,
    {
      ...props,
      flowId,
...
const checkInitialBodySidebarClass = () => {
  if (!document.body.classList.contains("waldiez-sidebar-collapsed") && !document.body.classList.contains("waldiez-sidebar-expanded")) {
...
const importFlow = (data) => {
  const flow = flowMapper.importFlow(data);
  return flowMapper.toReactFlow(flow);
};
const exportFlow = (data, hideSecrets = true, skipLinks = true) => {
  const flow = flowMapper.importFlow(data);
