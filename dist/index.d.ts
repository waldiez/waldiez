 ...
 */
export declare type CodeExecutionReplyData = BaseMessageData & {
 ...
 */
export declare type GroupChatRunData = BaseMessageData & {
 ...
 */
export declare type InputRequestData = BaseMessageData & {
    type: "input_request";
    request_id: string;
    prompt: string;
 ...
 */
export declare type MessageProcessingContext = {
 ...
 */
export declare type PrintMessageData = BaseMessageData & {
    type: "print";
    content: {
        data: string;
    };
 ...
 */
export declare type SpeakerSelectionData = BaseMessageData & {
 ...
 */
export declare type TextMessageData = BaseMessageData & {
    type: "text" | "tool_call";
    content: {
