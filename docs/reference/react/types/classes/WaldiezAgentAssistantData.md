...
Defined in: src/waldiez/models/Agent/Assistant/AssistantData.ts:33
...
> **new WaldiezAgentAssistantData**(`props`): `WaldiezAgentAssistantData`

Defined in: src/waldiez/models/Agent/Assistant/AssistantData.ts:34
